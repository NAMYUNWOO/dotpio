...
## 2026-04-02 19:22 KST — Adaptive-focus preference regression hardening
- Added deterministic payload assertion for `...AdaptiveFocusAliasPreferenceAbSweep` (`A=PH|B=HP|C=ES`).
- Added markdown order and parity checks for `TSDPMFXVWCRITSPMBSAPFP` + `TSDPMFXVWCRITSPMBSAPFPAB` with PH/HP/ES domain guardrails.
- Verification bundle passed (`py_compile`, `regression_check_lane_coverage_guardrail`, guardrail artifact regeneration).
...
## [2026-04-03 15:52 KST] Cycle IP48 follow-up — regression coverage
- Added regression assertions for `TSDCAD24TRIV` presence, decode legend presence, `TSDCAD24TRIVLEN` eval row, and row-count parity against `TSDCAD24TRI`.
...
- Added fixture-level parity assertion coverage for `TSDCAD24TRIGAPC` row counts mirroring `TSDCAD24TRIGAP` across summary/token sections.
- Added strict adjacency assertion to ensure `TSDCAD24TRIGAPC` stays immediately after `TSDCAD24TRIGAPM` and immediately before `TSDCAD24TRIGAP legend`.
- Verification bundle passed: py_compile + `scripts/regression_check_lane_coverage_guardrail.py` + guardrail artifact regeneration.
...
- 2026-04-04 11:23 KST — QA regression expectations updated for compact NVH INIT decode legend string; py_compile + regression + guardrail regen all PASS.
...
- 2026-04-04 16:18 KST — QA re-ran guardrail regression bundle after helper text change; parity/order assertions still pass for summary/token sections.
...
## 2026-04-04 21:49 KST — IP75 verification
- QA PASS: `python3 -m py_compile ...` + `python3 scripts/regression_check_lane_coverage_guardrail.py` + guardrail artifact regeneration.
- Added next injected QA target: sparse mixed-window PASS parity lock for `TSDPMFXVWCRITSPMBLEN`.
...
## 2026-04-04 22:49 KST — IP76 regression parity lock
- Decision: Added presence + row-count parity + adjacency assertions for `TSDPMFXVWCRITSPMBCH` against `...SPMB`/`...SPMBCLEG` across summary+token sections.
- Verification: py_compile + regression script + live guardrail run all PASS.
...
## 2026-04-05 02:50 KST — Verification bundle PASS
- `python3 -m py_compile scripts/check_lane_coverage_guardrail.py scripts/regression_check_lane_coverage_guardrail.py`
- `python3 scripts/regression_check_lane_coverage_guardrail.py`
- `python3 scripts/check_lane_coverage_guardrail.py --backlog POST_RC_BACKLOG.md --max-items 10 --cap-ratio 0.40 --json-out logs/weekly_lane_coverage_guardrail.json --md-out logs/weekly_lane_coverage_guardrail.md`
...
- Verification: `python3 -m py_compile scripts/check_lane_coverage_guardrail.py scripts/regression_check_lane_coverage_guardrail.py` + `python3 scripts/regression_check_lane_coverage_guardrail.py` + `python3 scripts/check_lane_coverage_guardrail.py --backlog POST_RC_BACKLOG.md --max-items 10 --cap-ratio 0.40 --json-out logs/weekly_lane_coverage_guardrail.json --md-out logs/weekly_lane_coverage_guardrail.md`.
- 2026-04-05 05:05 KST — Regression suite updated to assert presence, strict adjacency, and parity for `MBCBNY`, `MBCBNXA`, `MBCBNXALEG`; full guardrail regeneration PASS.
...
## 2026-04-05 22:22 KST — IP92 follow-up regression coverage
...
- QA validated PINLEN row-count parity mismatch diagnostics now carry explicit assertion label `tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinlenNonPassRows` in first-diverged failure output.
- Diagnostics-family contract is now aligned across PIN chain parity checks (`...pinlenNonPassRows`, `...pinsafeNonPassRows`, `...safeNonPassRows`) for one-scan sparse fixture triage.
- Verification PASS: `python3 -m py_compile scripts/check_lane_coverage_guardrail.py scripts/regression_check_lane_coverage_guardrail.py`; `python3 scripts/regression_check_lane_coverage_guardrail.py`; `python3 scripts/check_lane_coverage_guardrail.py --backlog POST_RC_BACKLOG.md --max-items 10 --cap-ratio 0.40 --json-out logs/weekly_lane_coverage_guardrail.json --md-out logs/weekly_lane_coverage_guardrail.md`.
...
## 2026-04-08 00:57 KST — QA regression contract extension
- Decision: Updated regression expectation to require ALT18 placeholder assertion labels in docs-order helper.
- Evidence: `python3 scripts/regression_check_lane_coverage_guardrail.py` passed (`ok: trendScoreBand dispatch-hint/momentum-band regression checks passed`).
- Follow-up: Add concrete ALT18 non-pass extraction assertions when payload rows exist.
