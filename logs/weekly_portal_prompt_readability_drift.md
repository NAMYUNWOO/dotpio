...
- GeneratedAt(UTC): 2026-03-25T06:38:48.734842Z
- Status: **OK**
- Window: last 7 days (max 120 commits)
- Checked commits: 120
- Portal prompt commits: 50
- Dominant mode commits: compact=20, detailed=1, neutral=29
- MODE TREND: **COMPACT**
...
- ARW AUTO PLAN CONF MOMENTUM: **FREEZE** (lock-or-candidate-suppressed; oscillating=False streak=17 confΔ=+0 planΔ=+0 driftRisk=HIGH offlineOnly=True)
- ARW MOMENTUM: **FLAG OFF** (flag=DOTPIO_EXPERIMENT_ARW_MOMENTUM_ALIAS enabled=False full=FREEZE)
- ARW MOMENTUM SCORE: **93** (base=85 confΔ=+0 planΔ=+0 streak=17 driftRisk=HIGH parity=LOCK)
...
- AMBIENT RAMP WHY REC CONF STREAK: **17** (suppress=FALSE threshold=3 reason=confidence-streak-extended)
...
- DRIFT MOMENTUM: **FLAT** (recent=2.68 older=1.12 delta=1.56)
- ACTION STABILITY: **WATCH** (retune-watch-needed; conf=LOW vol=STEADY momentum=FLAT)
- PRESSURE LAG: **SLOW** (churn=23 momentum=FLAT |Δ|=1.56)
...
- ROUTE PULSE LINK MODE STREAK: **57** (mode-stable-extended; current=IDLE prior=IDLE priorStreak=56 loaded=True)
...
- ROUTE PULSE LINK MODE FIT: **SYNC** (mode-stable-multi-window; mode=IDLE drift=+0 streak=57)
...
- ARW AUTO PLAN CANDIDATE SUPPRESS: **FALSE** (streak=17 threshold=3)
...
- LBA: **OFF** (flag=DOTPIO_EXPERIMENT_LANE_BUCKET_AGE_ALIAS enabled=False sys=999h dw=11h cv=21h)
- LANE BUCKET AGE: **SYSTEMS/OPS 999H | DESIGN/WORLD 11H | COMBAT/VFX 21H** (status=GAP window=24h)
...
- LPR HYS THRESH REC: **LPR HYS THRESH REC:RAISE** (base=12 rec=16 floor=10 ceil=22 priorWindow=True volSpan=1 maxAbsMom=1 ageSpread=988 learn=high volatility widened window upward to reduce flap risk reason=lane-age volatility is high; raise threshold to suppress flapping)
...
- LPR HYS WINDOW: **LPR HYS WINDOW:WIDE** (floor=10 ceil=22 span=12 reason=adaptive window is wide to suppress lane-priority flapping)
