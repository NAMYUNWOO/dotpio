...
- GeneratedAt(UTC): 2026-03-25T03:04:15.091422Z
- Status: **OK**
...
- ARW AUTO PLAN CONF MOMENTUM: **FREEZE** (lock-or-candidate-suppressed; oscillating=False streak=5 confΔ=+0 planΔ=+0 driftRisk=HIGH offlineOnly=True)
- ARW MOMENTUM: **FLAG OFF** (flag=DOTPIO_EXPERIMENT_ARW_MOMENTUM_ALIAS enabled=False full=FREEZE)
- ARW MOMENTUM SCORE: **93** (base=85 confΔ=+0 planΔ=+0 streak=5 driftRisk=HIGH parity=LOCK)
...
- AMBIENT RAMP WHY REC CONF STREAK: **5** (suppress=FALSE threshold=3 reason=confidence-streak-extended)
...
- ROUTE PULSE LINK MODE STREAK: **45** (mode-stable-extended; current=IDLE prior=IDLE priorStreak=44 loaded=True)
...
- ROUTE PULSE LINK MODE FIT: **SYNC** (mode-stable-multi-window; mode=IDLE drift=+0 streak=45)
...
- ARW AUTO PLAN CANDIDATE SUPPRESS: **FALSE** (streak=5 threshold=3)
...
- LBA: **OFF** (flag=DOTPIO_EXPERIMENT_LANE_BUCKET_AGE_ALIAS enabled=False sys=999h dw=8h cv=17h)
- LANE BUCKET AGE: **SYSTEMS/OPS 999H | DESIGN/WORLD 8H | COMBAT/VFX 17H** (status=GAP window=24h)
