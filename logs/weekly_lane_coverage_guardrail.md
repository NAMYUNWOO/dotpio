...
- trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback alias candidate (design/world+combat/vfx, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF:CCF**
