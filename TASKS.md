...
- [~] Combat/VFX Team (injected): Add compact operator cue alias token for `STPRLEN` status (`LOCK=GLINT-HOLD`, `WATCH=PULSE-PROBE`) and keep <=72-width decode row. *(lifecycle: [ ] -> [~] started: 2026-04-03 23:10 KST)*
