...
- [ ] UX/Design Team: Evaluate compact alias form for momentum-slope recommendation row (`TSDPMSR`) under DOS-width constraints.
- [ ] Systems/QA Team: Add explicit schema/domain lock for future `TSDPMSR` alias token once copy deck is finalized.
