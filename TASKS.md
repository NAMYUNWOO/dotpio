...
Last updated: 2026-04-05 01:49 KST
...
- [ ] Systems/Ops + QA Team (injected): Add sparse mixed-window fixture tuple assertion that `TSDPMFXVWCRITSPMBCBNT` row count mirrors `TSDPMFXVWCRITSPMB` across summary/token sections.
- [ ] Design/World Team (injected): Add compact decode helper clarifying `U/F/D` routing intent (`surge->HC2, hold->PP2, cool->SN2`) under <=72-char budget.
