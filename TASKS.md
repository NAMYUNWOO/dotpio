...
- [ ] Design/World + Combat/VFX Team (injected): prototype ALT22 candidate/eval/rationale trio (`PIN=GLINT meridian|SAFE=SHIELD brace`) behind report-only rollback wording gate.
