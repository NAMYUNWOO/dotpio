...
- [ ] Combat/VFX + Design Team (injected): Prototype third offline compact cue candidate (`GN/PS/SD`) as report-only token so readability A/B/C can run without runtime coupling.
