...
- [ ] AI-content + Combat/VFX Team (injected): prototype ALT21 candidate/eval/rationale trio (`PIN=GLINT azimuth|SAFE=SHIELD brace`) behind report-only rollback wording gate.
