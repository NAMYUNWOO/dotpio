...
- [ ] Systems/Ops + QA Team (injected): add fixture-level domain assertion that `...NFXQBACK` remains constrained to `AR|XR|SR` across mixed-window summary/token sections with explicit first-diverged diagnostics.
