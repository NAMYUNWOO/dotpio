...
- Next injected queue (IP82):
  ...
  - [ ] Design/World Team (injected): add DOS-width evaluation helper row for quick-map decode legend compactness (`...MBCBNXDMAPLEGLEN`).
...
- Next injected queue (IP83 cadence recovery):
  - [ ] Combat/VFX Team (injected): add quick-map narrative alias intensity decode helper row (`...MBCBNXDMAPNFX`) for one-scan cue readability.
  - [ ] Design/World Team (injected): add DOS-width eval + preference lock row for quick-map narrative alias decode (`...MBCBNXDMAPNLEN`).
  - [ ] Systems/Ops + QA Team (injected): add mixed-window parity/order fixture assertions for `...MBCBNXDMAPN` + `...MBCBNXDMAPNLEG` rows.
