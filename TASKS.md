...
- [ ] Systems/Ops + QA Team (injected): add mixed-window fixture parity assertion that `TSDPMFXVWCRITSPMBCBNXDMAPNFXQLEVAL` row count mirrors `TSDPMFXVWCRITSPMB` across summary/token sections.
