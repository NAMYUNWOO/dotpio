...
- [ ] UX/Design Team: Prototype optional summary/token-coverage micro-row for `CBGCFXWSBPFXPINF BURST` directly between `CBGCFXWSBPFXPINF` and `CBGCFXWSBPFXPINF ORDER` with 0|2 cardinality contract.
