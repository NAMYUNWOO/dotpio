...
## Next Up (Game Director Injection — Cycle IP138)
- [ ] Systems/Ops + QA Team (injected): add sparse first-diverged row-count parity assertion linking `...ALT19V20LEN` and `...ALT19V20R` so missing rationale rows expose comparator occurrence context in one failure path.
