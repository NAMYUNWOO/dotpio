...
- [ ] Systems/QA Team: Add optional markdown/token-coverage legend+order contract for `CBGCFXWSBPFCI` rollout path (`...FX CUE COMPACT ALIAS -> ...INTENSITY -> ...COACH COPY REC`).
- [ ] Design/AI Content Team: Prototype offline copy microline pair for intensity states (`BASE|RAISED`) to support future visible digest rollout.
