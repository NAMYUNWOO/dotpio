...
- [ ] Combat/VFX + AI-content Team (injected): prototype offline alternate shelter-tone wording candidate for `S` branch (report-only, no runtime coupling) and document rollback criteria.
