...
- [ ] Combat/VFX + AI-content Team (injected): Prototype offline compact fallback phase-note alias candidate for unknown trend states (`UNK->PP2`) with runtime coupling disabled.
