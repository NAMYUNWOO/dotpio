...
- [ ] Systems/Ops + QA Team (injected): Add fixture-level domain assertion that `...NFXQBACKSTAF2CTRLWVFXH` helper row remains constrained to ordered copy (`GLINT-HOLD first|PULSE-CUT second|SHIELD-HOLD third`) whenever `...CTRLWVFX` exists, with first-diverged fixture diagnostics.
