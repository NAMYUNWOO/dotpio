...
- [ ] Systems/QA Team (injected): Add regression fixture + checklist row coverage for `compatRowPolicySourceConfidenceAlias` and signal mirror fields.
- [ ] AI Content/Systems Team (injected): Prototype offline source-confidence trend recommendation (`compatRowPolicySourceConfidenceTrend:UP|FLAT|DOWN`) without runtime coupling.
