...
- [ ] Design/UX Team: Prototype confidence-adaptive rail compression token (`ROUTE GLOW FX CONF WHY RAIL MODE:LOCK|FLEX`) behind flag for prompt-budget resilience
