...
- [ ] GD-2026-03-30-fxpde-matrix-drift-snapshot-compact-alias-markdown: Surface optional markdown row + legend for `CBGCFXWSBPFXPDS` in summary/token-coverage rails with ordering contract lock.
- [ ] GD-2026-03-30-fxpde-matrix-drift-snapshot-triage-thresholds: Add configurable streak/band threshold policy (`WATCH|MANUAL`) in snapshot resolver for QA tuning without gameplay coupling.
