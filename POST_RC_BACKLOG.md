...
- [ ] Systems/QA Team (injected): Add fixture-level explicit parity assertion that `TSDCAD24TRICOVSTCMSV legend` count mirrors `TSDCAD24TRICOVSTCMSV` across summary/token sections.
