...
- [ ] AI-content + Combat/VFX (injected): prototype ALT21 docs-order handoff phrase candidate/eval/rationale trio (`PIN=GLINT azimuth|SAFE=SHIELD brace`) behind report-only rollback wording gate.
