...
- [ ] Design/World + UX Team (injected): add compact docs-order note that ALTLEN first-diverged parity failures now expose `assertionLabel=<...legaltlenNonPassRows>` alongside PINLEN/PINSAFE/SAFE diagnostics.
