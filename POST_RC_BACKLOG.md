...
- [ ] Design/World + Combat/VFX (injected): prototype ALT22 docs-order handoff phrase candidate/eval/rationale trio (`PIN=GLINT meridian|SAFE=SHIELD brace`) behind report-only rollback wording gate.
