...
- [ ] GD-2026-03-30-fxpde-matrix-trend-band: Add payload trend-band classification (`STABLE|SWING|SPIKE`) from matrix drift history for alert throttling.
- [ ] GD-2026-03-30-fxpde-matrix-drift-playtest-snapshot: Emit compact playtest snapshot section summarizing last-window FXPDE drift + recommendation for manual triage.
