...
- [ ] UX/Design: Prototype compact alias/decode row for momentum-slope recommendation state (`TSDPMSR`) with <=88-char DOS-width budget.
- [ ] Systems/QA: Add schema/domain and markdown-presence contract once `TSDPMSR` alias copy map is finalized.
