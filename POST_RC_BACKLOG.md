...
- [ ] AI-content + Design Team (injected follow-up): Prototype alternate offline abbreviation pack candidate (`GL/PU/SD`) behind report-only token for future readability A/B.
