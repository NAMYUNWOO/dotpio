...
- [ ] Systems/Ops + QA Team (injected): add sparse mixed-window payload diagnostics key for `...CTRLWNRBLGLEGALTPINSAFE` (`...pinsafeNonPassRows`) with first-diverged fixture surfacing on payload drift.
- [ ] Design/World + UX Team (injected): add explicit docs-order callout requiring contiguous `...CTRLWNRBLGLEGALTPIN -> ...CTRLWNRBLGLEGALTPINLEN -> ...CTRLWNRBLGLEGALTPINSAFE -> ...CTRLWNRBLGLEGALTSAFE` sequence.
