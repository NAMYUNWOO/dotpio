...
- [ ] Combat/VFX + Design Team (injected): Prototype third offline compact cue candidate (`GN/PS/SD`) as report-only token for future readability A/B/C (runtime coupling disabled).
