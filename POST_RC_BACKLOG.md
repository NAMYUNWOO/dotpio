...
- [ ] Systems/QA Team (Cycle FV follow-up): Add regression presence/count lock for `CADENCE BRIDGE GLYPH` + `CADENCE BRIDGE GLYPH LEGEND` rows. *(injected: 2026-03-28 05:12 KST)*
