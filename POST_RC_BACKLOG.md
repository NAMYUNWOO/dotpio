...
- [ ] Combat/VFX + UX Team (injected): Add compact eval row for VFX cue rollback decode ordering (`...CTRLWVFXRBLGLEN`) and keep strict chain `...CTRLWVFXRBLG -> ...CTRLWVFXRBLGLEN -> ...CTRLWN` to satisfy 24h combat-or-vfx cadence bucket.
