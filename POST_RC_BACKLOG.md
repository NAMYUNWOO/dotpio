...
- [ ] Systems/QA Team: Add checksum/domain regression lock for legend microcopy text (`phaseIntentLegendCopyHash`).
- [ ] AI-content/World Team: Prototype optional adaptive legend-copy phrasing rotor (offline-only, flag-gated).
