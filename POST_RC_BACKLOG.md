...
- [ ] Systems/Ops + QA Team (injected): Add fixture-level PASS-domain assertion for `...NFXQBACKVFXLEN` across sparse mixed-window summary/token matrices with mismatch labels.
