...
- [ ] Systems/QA Team (injected follow-up): Add explicit fixture-domain assertion that `TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKVFXA` payload stays within `GI|PU|SH` across mixed-window summary/token sections.
