...
- [ ] AI-content + Combat/VFX Team (injected): prototype tenth docs-order handoff phrase candidate (`...LEGALTPINVFXALT9:PIN=GLINT tether|SAFE=SHIELD brace`) with report-only rollback gate + eval row.
