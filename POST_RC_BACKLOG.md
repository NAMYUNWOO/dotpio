...
- [ ] Systems/Ops + QA Team (injected): Add explicit sparse-fixture rollback-domain assertion so `...NFXQBACKVFXDRB` is always `KEEP|ROLLBACK` with first-diverged mismatch surfacing.
