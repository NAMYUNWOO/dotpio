...
- [ ] Systems/Ops + QA (injected): sparse first-diverged row-count parity assertion linking `...ALT19V20LEN` and `...ALT19V20R` with comparator occurrence context in one failure path.
