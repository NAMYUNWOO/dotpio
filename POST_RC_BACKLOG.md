...
- [ ] UX/Design (idea backlog): Add compact contract decode helper row listing the enforced `NFXP->NFXPLEG->NFXPLEN->NFXPO->NFXPOA->NFXALEG` chain for one-glance reviewer onboarding.
