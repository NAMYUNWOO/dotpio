...
- Injected next backlog:
  ...
  - [ ] AI-content + Combat/VFX Team (injected): add report-only alternate compact alias experiment row for transition handoff decode helper and guard with deterministic mismatch diagnostics key.
