...
- [ ] Systems/QA Team (injected): Add deterministic fixture-level assertion that `TSDPCONWCTSB` row count mirrors `TSDPCONWCTS` row count across summary + token sections under mixed fixtures.
