...
CBGCFXWSBPFXP_MICROLINE_LEGEND_VERSION = "v1"
CBGCFXWSBPFXP_MICROLINE_LEGEND_MAP = {
    "S": "SOFT pulse",
    "P": "PUSH pulse",
}
_CBGCFXWSBPFXP_MICROLINE_LEGEND_SERIALIZED = json.dumps(CBGCFXWSBPFXP_MICROLINE_LEGEND_MAP, sort_keys=True, separators=(",", ":"))
CBGCFXWSBPFXP_MICROLINE_LEGEND_HASH = hashlib.sha256(_CBGCFXWSBPFXP_MICROLINE_LEGEND_SERIALIZED.encode("utf-8")).hexdigest()[:12]
CBGCFXWSBPFXPD_MICROLINE_LEGEND_VERSION = "v1"
CBGCFXWSBPFXPD_MICROLINE_LEGEND_MAP = {
...
TOKEN_ALIAS_FAMILIES = {
    ...
    "dmgComboConfidenceFxCoachCueAlias": ["DCCFXC:"],
    "dmgComboConfidenceFxCoachCueWhyAlias": ["DCCFXCW:"],
    "dmgComboConfidenceFxCoachCueWhyScenePaletteAlias": ["DCCFXCW SCENE PALETTE:"],
    ...
    "combatVfxCadenceCoachAlias": ["COMBAT/VFX CADENCE COACH:", "CVCC:"],
    ...
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorRecommendation": ["CVCWHR CONF FLOOR REC:"],
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorRecommendationAlias": ["CVCWHRF:"],
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseAlias": ["CVCWHR FX PULSE:"],
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias": ["CVCWHR FX LEGEND REC:"],
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias": ["CVCWHR FX LEGEND REC CONF:"],
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackAlias": ["CVCWHR FX LEGEND COPY PACK:", "CVCWHR FX LEGEND CP:", "CVCWHR FX LEGEND CPT:"],
    ...
    "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackAlias": ["CBGC INTENT ALT PACK:", "CBGCI:", "CBGCI LEGEND:", "CBGCIL:"],
    "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias": ["CBGCIA:"],
    "cadenceBridgeGlyphConfidenceFxPulseRegimeAlias": ["CBGCFXR:"],
    "cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias": ["CBGCFXA:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias": ["CBGC FX HINT:"],
    ...
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintWorldToneCoherenceArc": ["COHERENCE ARC:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoach": ["COHERENCE ARC COACH:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcAlias": ["CVARC:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAlias": ["CBGCFXWAC:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasLegend": ["CBGCFXWAC LEGEND:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasDrift": ["CBGCFXWAC DRIFT:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum": ["CBGCFXWAC MOMENTUM:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachCopyVariantRecommendationReasonPriorityAlias": ["CBGCFXWACRP:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseAlias": ["CBGCFXWSBPFXP:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat": ["CBGCFXWSB:"],
    "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase": ["CBGCFXWSBP:"],
...
def combat_vfx_cadence_coach(*, combat_vfx_cadence_watchdog_streak_signals: dict[str, object], lane_cadence_miss_risk_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline cadence escalation coach derived from watchdog breach streak and miss-risk level."""
    streak = int(combat_vfx_cadence_watchdog_streak_signals.get("streak", 0) or 0)
    status = str(combat_vfx_cadence_watchdog_streak_signals.get("status", "OK") or "OK").upper()
    miss_risk = str(lane_cadence_miss_risk_signals.get("risk", "MID") or "MID").upper()

    if status == "BREACH" and (streak >= 3 or miss_risk == "HIGH"):
        coach = "ESCALATE"
        reason = "breach-streak-or-high-risk-escalation"
    elif status == "BREACH" or miss_risk in {"MID", "HIGH"}:
        coach = "ARM"
        reason = "cadence-pressure-arming"
    else:
        coach = "NUDGE"
        reason = "cadence-healthy-soft-nudge"

    return f"COMBAT/VFX CADENCE COACH:{coach}", {
        "coach": coach,
        "watchdogStatus": status,
        "watchdogStreak": streak,
...
def combat_vfx_cadence_coach_why(*, combat_vfx_cadence_watchdog_streak_signals: dict[str, object], lane_cadence_miss_risk_signals: dict[str, object], prior_json_path: Path | None = None) -> tuple[str, dict[str, object]]:
    ...
    if risk == "HIGH" and streak_trend == "RISING":
        short = "RED CLIMB"
        reason = "high-risk-delta-with-rising-breach-streak"
    elif risk == "HIGH":
        short = "RED HOLD"
        reason = "high-risk-delta-with-flat-or-falling-streak"
    elif streak_trend == "RISING" and delta_hours >= 0:
        short = "AMBER PUSH"
        reason = "miss-risk-delta-nonnegative-with-rising-streak"
    elif streak_trend == "FALLING":
        short = "COOLING"
        reason = "streak-trend-falling"
    else:
    ...
    return token, {
        "short": short,
        "reason": reason,
        "laneCadenceMissRisk": risk,
        "laneCadenceDeltaHours": delta_hours,
        "watchdogStreak": streak,
...
def resolve_combat_vfx_cadence_coach_why_alias(*, coach_why_token: str) -> tuple[str, dict[str, object]]:
    """Compact alias for cadence coach rationale (`CVCW:<R|H|P|C|B>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    alias_map = {
        "COMBAT/VFX CADENCE COACH WHY:RED CLIMB": "R",
        "COMBAT/VFX CADENCE COACH WHY:RED HOLD": "H",
        "COMBAT/VFX CADENCE COACH WHY:AMBER PUSH": "P",
        "COMBAT/VFX CADENCE COACH WHY:COOLING": "C",
        "COMBAT/VFX CADENCE COACH WHY:BASELINE WATCH": "B",
    }
    alias = alias_map.get(coach_why_token, "B")
    token = f"CVCW:{alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "coachWhyToken": coach_why_token,
        "alias": token,
    }


def resolve_combat_vfx_cadence_coach_alias(*, coach_token: str) -> tuple[str, dict[str, object]]:
    """Compact alias for cadence coach posture (`CVCC:<N|A|E>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    alias_map = {
        "COMBAT/VFX CADENCE COACH:NUDGE": "N",
        "COMBAT/VFX CADENCE COACH:ARM": "A",
        "COMBAT/VFX CADENCE COACH:ESCALATE": "E",
    }
    alias = alias_map.get(coach_token, "A")
    token = f"CVCC:{alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_alias(*, coach_why_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Compact alias for coach-why hysteresis floor state (`CVCWH:<H|S>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_HYST_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    hysteresis_applied = bool(coach_why_signals.get("hysteresisApplied", False))
    token = "CVCWH:H" if hysteresis_applied else "CVCWH:S"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "hysteresisApplied": hysteresis_applied,
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_recommendation_alias(*, coach_why_signals: dict[str, object], lane_cadence_miss_risk_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline recommendation alias for adaptive coach-why hysteresis posture.

    `CVCWHR:HOLD` suggests sticky behavior should remain conservative; `CVCWHR:RELAX`
    suggests release conditions are recovering.
    """
    volatility = str(coach_why_signals.get("watchdogStreakTrendVolatility", "CALM") or "CALM").upper()
    risk = str(lane_cadence_miss_risk_signals.get("risk", "MID") or "MID").upper()
    delta_hours = float(lane_cadence_miss_risk_signals.get("deltaHours", 0.0) or 0.0)
    hysteresis_applied = bool(coach_why_signals.get("hysteresisApplied", False))

    hold = hysteresis_applied or volatility in {"SWING", "SPIKE"} or (risk == "HIGH" and delta_hours >= -4.0)
    recommendation = "CVCWHR:HOLD" if hold else "CVCWHR:RELAX"
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation(*, coach_why_signals: dict[str, object], recommendation_confidence_signals: dict[str, object], lane_cadence_miss_risk_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline adaptive confidence-floor recommendation for `CVCWHR CONF`.

    Policy uses miss-risk recovery slope + volatility persistence windows (watchdog streak)
    to suggest whether to keep, raise, or relax the confidence floor.
    """
    risk = str(lane_cadence_miss_risk_signals.get("risk", "MID") or "MID").upper()
    volatility = str(recommendation_confidence_signals.get("volatility", coach_why_signals.get("watchdogStreakTrendVolatility", "CALM")) or "CALM").upper()
    recovery_slope = float(recommendation_confidence_signals.get("recoverySlopeHours", coach_why_signals.get("laneCadenceDeltaHours", 0.0)) or 0.0)
    persistence_windows = int(coach_why_signals.get("watchdogStreak", 0) or 0)
    delta_hours = float(lane_cadence_miss_risk_signals.get("deltaHours", 0.0) or 0.0)

    recommendation = "CVCWHR CONF FLOOR REC:KEEP"
    reason = "balanced"
    swing_persistence_bias_applied = False
    if risk == "HIGH" and volatility in {"SWING", "SPIKE"} and persistence_windows >= 2 and recovery_slope > -2.0:
        recommendation = "CVCWHR CONF FLOOR REC:RAISE"
        reason = "persistent-pressure"
    elif risk == "LOW" and volatility == "CALM" and persistence_windows >= 2 and recovery_slope <= -4.0 and delta_hours <= -4.0:
        recommendation = "CVCWHR CONF FLOOR REC:RELAX"
        reason = "stable-recovery"

    # FM high-risk prototype (offline-only): sustained SWING volatility (3+ windows)
    # biases confidence-floor recommendation toward RAISE unless we are already in
    # explicit stable-recovery conditions.
    if recommendation != "CVCWHR CONF FLOOR REC:RELAX" and volatility == "SWING" and persistence_windows >= 3:
        recommendation = "CVCWHR CONF FLOOR REC:RAISE"
        reason = "sustained-swing-bias"
        swing_persistence_bias_applied = True

    return recommendation, {
        "risk": risk,
        "volatility": volatility,
        "recoverySlopeHours": recovery_slope,
        "persistenceWindows": persistence_windows,
        "deltaHours": delta_hours,
        "reason": reason,
        "swingPersistenceBiasApplied": swing_persistence_bias_applied,
        "offlineOnly": True,
    }


def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_alias(*, recommendation_token: str) -> tuple[str, dict[str, object]]:
    """Compact alias for confidence-floor recommendation (`CVCWHRF:<K|R|X>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_HYST_REC_CONF_FLOOR_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    alias_map = {
        "CVCWHR CONF FLOOR REC:KEEP": "K",
        "CVCWHR CONF FLOOR REC:RAISE": "R",
        "CVCWHR CONF FLOOR REC:RELAX": "X",
    }
    alias = alias_map.get(recommendation_token, "K")
    token = f"CVCWHRF:{alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "recommendationToken": recommendation_token,
        "alias": alias,
    }


def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse(*, confidence_floor_recommendation_token: str, recommendation_confidence_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline FX pulse cue from `CVCWHR CONF FLOOR REC` for postmortem feel triage continuity."""
    recommendation = confidence_floor_recommendation_token.split(":", 1)[-1].strip().upper()
    confidence = str(recommendation_confidence_signals.get("confidence", "MID") or "MID").upper()

    pulse = "EDGE"
    reason = "balanced-floor"
    if recommendation == "RAISE":
        pulse = "HARD"
        reason = "raised-floor-guard"
    elif recommendation == "RELAX" and confidence == "HIGH":
        pulse = "SOFT"
        reason = "relaxed-floor-high-confidence"

    token = f"CVCWHR FX PULSE:{pulse}"
    return token, {
        "pulse": pulse,
        "confidenceFloorRecommendation": confidence_floor_recommendation_token,
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_recommendation(*, lane_cadence_miss_risk_signals: dict[str, object], recommendation_confidence_signals: dict[str, object], legend_variant_confidence_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline copy-pack recommendation (`TERSE|DIRECTIVE|NARRATIVE`) from miss-risk momentum deltas."""
    risk = str(lane_cadence_miss_risk_signals.get("risk", "MID") or "MID").upper()
    delta_hours = float(lane_cadence_miss_risk_signals.get("deltaHours", 0.0) or 0.0)
    volatility = str(recommendation_confidence_signals.get("volatility", "CALM") or "CALM").upper()
    confidence = str(legend_variant_confidence_signals.get("confidence", "MID") or "MID").upper()

    pack = "DIRECTIVE"
    reason = "balanced-momentum-default"
    if risk == "HIGH" and delta_hours >= 3 and volatility in {"SWING", "SPIKE"}:
        pack = "TERSE"
        reason = "high-risk-rising-momentum-volatile-regime"
    elif risk == "LOW" and delta_hours <= 0 and volatility == "CALM" and confidence == "HIGH":
        pack = "NARRATIVE"
        reason = "low-risk-cooling-momentum-calm-regime"
    elif confidence == "LOW" and volatility == "SPIKE":
        pack = "TERSE"
        reason = "low-confidence-spike-regime"

    token = f"CVCWHR FX LEGEND COPY PACK:{pack}"
    return token, {
        "pack": pack,
        "risk": risk,
        "deltaHours": delta_hours,
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias(*, copy_pack_token: str) -> tuple[str, dict[str, object]]:
    """Compact alias for copy-pack recommendation (`CVCWHR FX LEGEND CP:<T|D|N>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_HYST_REC_CONF_FX_LEGEND_COPY_PACK_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    alias_map = {
        "CVCWHR FX LEGEND COPY PACK:TERSE": "T",
        "CVCWHR FX LEGEND COPY PACK:DIRECTIVE": "D",
        "CVCWHR FX LEGEND COPY PACK:NARRATIVE": "N",
    }
    alias = alias_map.get(copy_pack_token, "D")
    token = f"CVCWHR FX LEGEND CP:{alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "copyPackToken": copy_pack_token,
        "alias": alias,
    }


def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend(*, copy_pack_token: str, lane_cadence_miss_risk_signals: dict[str, object], prior_json_path: Path) -> tuple[str, dict[str, object]]:
    """Offline copy-pack drift trend policy (`COPY PACK TREND:STABLE|SHIFTING`) from prior-window momentum shifts."""
    current_pack = copy_pack_token.split(":", 1)[-1].strip().upper()
    current_delta = float(lane_cadence_miss_risk_signals.get("deltaHours", 0.0) or 0.0)
    ...
    if prior_json_path.is_file():
        try:
            prior_payload = json.loads(prior_json_path.read_text(encoding="utf-8"))
            prior_pack = str(prior_payload.get("combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPack", "") or "").split(":", 1)[-1].strip().upper()
            prior_signals = prior_payload.get("laneCadenceMissRiskSignals", {})
            if isinstance(prior_signals, dict):
                prior_delta = float(prior_signals.get("deltaHours", 0.0) or 0.0)
            prior_loaded = bool(prior_pack)
        except (json.JSONDecodeError, TypeError, ValueError):
            pass

    same_pack = bool(prior_loaded and prior_pack == current_pack)
    momentum_shift = abs(current_delta - prior_delta)
    trend = "STABLE"
    reason = "copy-pack-and-momentum-stable-vs-prior"
    if (not prior_loaded) or (not same_pack) or momentum_shift >= 1.0:
        trend = "SHIFTING"
        if not prior_loaded:
            reason = "no-prior-window-copy-pack"
        elif not same_pack:
            reason = "copy-pack-changed-vs-prior-window"
        else:
            reason = "momentum-delta-shifted-vs-prior-window"

    token = f"COPY PACK TREND:{trend}"
    return token, {
        "trend": trend,
        "copyPack": current_pack,
        "priorCopyPack": prior_pack or "NONE",
        "deltaHours": current_delta,
        "priorDeltaHours": prior_delta,
        "momentumShiftHours": momentum_shift,
        "priorLoaded": prior_loaded,
        "reason": reason,
        "offlineOnly": True,
    }
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias(*, trend_token: str) -> tuple[str, dict[str, object]]:
    """Compact alias for copy-pack trend token (`CVCWHR FX LEGEND CPT:<S|H>`)."""
    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_HYST_REC_CONF_FX_LEGEND_COPY_PACK_TREND_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    trend = trend_token.split(":", 1)[-1].strip().upper()
    alias_map = {"STABLE": "S", "SHIFTING": "H"}
    alias = alias_map.get(trend, "S")
    token = f"CVCWHR FX LEGEND CPT:{alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "trendToken": trend_token,
        "trend": trend,
        "alias": alias,
    }


def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence(*, trend_token: str, trend_signals: dict[str, object]) -> tuple[str, dict[str, object]]:
    """Offline confidence tier for copy-pack trend stability (`LOW|MID|HIGH`) plus compact alias `CVCWHR FX LEGEND CPTC`."""
    trend = trend_token.split(":", 1)[-1].strip().upper()
    prior_loaded = bool(trend_signals.get("priorLoaded", False))
    momentum_shift_hours = abs(float(trend_signals.get("momentumShiftHours", 0.0) or 0.0))

    confidence = "HIGH"
    reason = "trend-stable-with-prior-window"
    if trend == "SHIFTING":
        confidence = "LOW"
        reason = "trend-shifting-needs-attention"
    elif (not prior_loaded) or momentum_shift_hours >= 0.5:
        confidence = "MID"
        reason = "limited-prior-context-or-noticeable-shift"

    token = f"CVCWHR FX LEGEND COPY PACK TREND CONF:{confidence}"

    flag_name = "DOTPIO_EXPERIMENT_COMBAT_VFX_CADENCE_COACH_WHY_HYST_REC_CONF_FX_LEGEND_COPY_PACK_TREND_CONF_ALIAS"
    flag_enabled = os.environ.get(flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    alias_map = {"LOW": "L", "MID": "M", "HIGH": "H"}
    alias = alias_map.get(confidence, "M")
    alias_token = f"CVCWHR FX LEGEND CPTC:{alias}"

    return token, {
        "confidence": confidence,
        "trend": trend,
        "priorLoaded": prior_loaded,
        "momentumShiftHours": momentum_shift_hours,
        "reason": reason,
        "offlineOnly": True,
        "aliasToken": (alias_token if flag_enabled else "FLAG OFF"),
        "alias": alias,
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
    }
...
def resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_note(*, trend_token: str, trend_confidence_signals: dict[str, object], prior_json_path: Path) -> tuple[str, dict[str, object]]:
    """Offline override note when CPTC confidence diverges from trend direction for 2+ windows."""
    trend = trend_token.split(":", 1)[-1].strip().upper()
    confidence = str(trend_confidence_signals.get("confidence", "MID") or "MID").upper()

    expected_confidence = "HIGH" if trend == "STABLE" else "LOW"
    diverged = confidence != expected_confidence
    ...
    if prior_json_path.is_file():
        try:
            ...
            prior_signals = prior_payload.get(
                "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendConfidenceOverrideSignals", {}
            )
            if isinstance(prior_signals, dict):
                prior_streak = int(prior_signals.get("mismatchStreak", 0) or 0)
                prior_loaded = True
        except (json.JSONDecodeError, TypeError, ValueError):
            pass

    mismatch_streak = prior_streak + 1 if diverged else 0
    override = "ON" if mismatch_streak >= 2 else "OFF"

    if override == "ON":
        note = "trend-confidence-diverged-for-2-plus-windows"
    elif diverged:
        note = "first-window-divergence-observed"
    else:
        note = "trend-and-confidence-aligned"

    token = f"CVCWHR FX LEGEND CPTC OVERRIDE:{override}"
    return token, {
        "override": override,
        "trend": trend,
        "confidence": confidence,
        ...
        "priorMismatchStreak": prior_streak,
        "priorLoaded": prior_loaded,
        "reason": note,
        "offlineOnly": True,
    }
...
def cadence_bridge_from_cvcwhr_floor_and_lane_freshness(*, confidence_floor_recommendation_token: str, lane_bucket_age: dict[str, object]) -> tuple[str, dict[str, object]]:
    ...
    systems_ops_age = int(age_hours.get("systems/ops", 999) or 999)
    combat_vfx_age = int(age_hours.get("combat/vfx", 999) or 999)
    floor = confidence_floor_recommendation_token.split(":", 1)[-1].strip().upper()

    bridge = "HOLD"
    reason = "balanced-bridge-hold"
    if floor == "RELAX" and design_world_age <= 24:
        bridge = "SCOUT"
        reason = "fresh-design-world-safe-scout"
    elif design_world_age > 24 or (floor == "RAISE" and design_world_age >= systems_ops_age):
        bridge = "PRESS"
        reason = "design-world-freshness-gap-or-raised-floor"

    token = f"CADENCE BRIDGE:{bridge}"
    return token, {
        "bridge": bridge,
        "confidenceFloorRecommendation": confidence_floor_recommendation_token,
        "designWorldAgeHours": design_world_age,
...
def cadence_bridge_glyph_confidence_from_gap_volatility(*, cadence_bridge_glyph_signals: dict[str, object], prior_json_path: Path) -> tuple[str, dict[str, object]]:
    ...
    current_gap = int(cadence_bridge_glyph_signals.get("designWorldGapHours", 0) or 0)
    prior_loaded = False
    prior_gap = 0
    prior_gap_token = ""
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint(
    *,
    fx_pulse_signals: dict[str, object],
    narrative_signals: dict[str, object] | None = None,
) -> tuple[str, dict[str, object]]:
    """Human-readable offline triage hint with world-tone variants derived from CBGC posture."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_HINT"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    mode = str(fx_pulse_signals.get("aggressivenessMode", "BASELINE") or "BASELINE").strip().upper()
    pulse = str(fx_pulse_signals.get("resolvedPulse", "EDGE") or "EDGE").strip().upper()
    narrative_current = str((narrative_signals or {}).get("current", "unknown") or "unknown").strip().lower()
    tone_cue_map = {
        "steady": "calm skyline",
        "swing": "faultline jitter",
        "spike": "breachfront surge",
        "unknown": "neutral field",
    }
    tone_cue = tone_cue_map.get(narrative_current, tone_cue_map["unknown"])
    variant_pack = {
        "CAUTIOUS": {
            "steady": "watch lane drift; keep calm skyline",
            "swing": "watch lane drift; brace faultline seams",
            "spike": "watch lane drift; shield breachfront edges",
            "unknown": "watch lane drift; preserve stability",
        },
        "BASELINE": {
            "steady": "tune pressure deliberately; keep calm skyline",
            "swing": "tune pressure deliberately; steady faultline seams",
            "spike": "tune pressure deliberately; damp breachfront surge",
            "unknown": "track pressure and tune deliberately",
        },
        "AGGRESSIVE": {
            "steady": "push triage now; lock calm skyline anchors",
            "swing": "push triage now; contain faultline seams",
            "spike": "push triage now; seal breachfront surge",
            "unknown": "triage spikes now; prioritize containment",
        },
    }
    mode_pack = variant_pack.get(mode, variant_pack["BASELINE"])
    hint = mode_pack.get(narrative_current, mode_pack["unknown"])
    token = f"CBGC FX HINT:{hint}"
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "worldToneCue": tone_cue,
        "worldToneVariantPack": variant_pack,
        "hint": hint,
        "aliasToken": token,
        "offlineOnly": True,
    }
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias(
    *,
    microcopy_hint_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact microcopy-hint alias (`CBGCFXH:<W|T|P>`) for dense digest scans."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_HINT_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    mode = str(microcopy_hint_signals.get("aggressivenessMode", "BASELINE") or "BASELINE").strip().upper()
    alias_map = {
        "CAUTIOUS": "W",
        "BASELINE": "T",
        "AGGRESSIVE": "P",
    }
    alias = alias_map.get(mode, "T")
    token = f"CBGCFXH:{alias}"
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "alias": alias,
        "aliasToken": token,
        "sourceToken": str(microcopy_hint_signals.get("aliasToken", "CBGC FX HINT:")),
        "offlineOnly": True,
    }
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias(
    *,
    microcopy_hint_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact world-tone alias (`CBGCFXW:<S|J|B|N>`) for CBGC FX hint narrative posture."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    narrative_current = str(microcopy_hint_signals.get("narrativeCurrent", "unknown") or "unknown").strip().lower()
    world_tone_cue = str(microcopy_hint_signals.get("worldToneCue", "neutral field") or "neutral field").strip()
    alias_map = {
        "steady": "S",
        "swing": "J",
        "spike": "B",
    ...
    alias = alias_map.get(narrative_current, "N")
    token = f"CBGCFXW:{alias}"

    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "narrativeCurrent": narrative_current,
        "worldToneCue": world_tone_cue,
        "alias": alias,
        "aliasToken": token,
        "sourceToken": str(microcopy_hint_signals.get("aliasToken", "CBGC FX HINT:")),
        "offlineOnly": True,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_legend(
    *,
    world_tone_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Optional compact legend row for CBGCFXW alias decode readability."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_LEGEND"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    legend = "S=steady skyline, J=jitter faultline, B=breach surge, N=neutral field"
    token = f"CBGCFXW LEGEND:{legend}"
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "narrativeCurrent": str(world_tone_alias_signals.get("narrativeCurrent", "unknown") or "unknown").strip().lower(),
        "activeAlias": str(world_tone_alias_signals.get("alias", "N") or "N").strip().upper(),
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum(
    *,
    coherence_signals: dict[str, object],
    prior_json_path: Path,
) -> tuple[str, dict[str, object]]:
    """Offline coherence-momentum token from coherence streak deltas."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_MOMENTUM"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    current_status = str(coherence_signals.get("status", "OK") or "OK").strip().upper()
    current_drift_streak = int(coherence_signals.get("driftStreak", 0) or 0)

    prior_loaded = False
    prior_status = "OK"
    prior_drift_streak = 0
    if prior_json_path.exists():
        try:
            prior_payload = json.loads(prior_json_path.read_text(encoding="utf-8"))
            prior_signals = prior_payload.get("cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceSignals", {})
            if isinstance(prior_signals, dict):
                prior_status = str(prior_signals.get("status", "OK") or "OK").strip().upper()
                prior_drift_streak = int(prior_signals.get("driftStreak", 0) or 0)
                prior_loaded = True
        except (json.JSONDecodeError, OSError, ValueError, TypeError):
            prior_status = "OK"
            prior_drift_streak = 0

    drift_streak_delta = current_drift_streak - prior_drift_streak
    momentum = "STABLE" if (not prior_loaded or drift_streak_delta == 0) else "WOBBLE"
    token = f"CBGCFXW COHERENCE MOMENTUM:{momentum}"
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "priorStatus": prior_status,
        "currentDriftStreak": current_drift_streak,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc(
    *,
    coherence_signals: dict[str, object],
    coherence_momentum_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline narrative cue from coherence + momentum state (`COHERENCE ARC:LOCK|SWAY`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias(
    *,
    coherence_arc_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact alias for `COHERENCE ARC` (`CVARC:<L|S>`) for dense combat digest overlays."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    arc = str(coherence_arc_signals.get("arc", "SWAY") or "SWAY").strip().upper()
    alias_map = {
        "LOCK": "L",
        "SWAY": "S",
    }
    alias = alias_map.get(arc, "S")
    token = f"CVARC:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair(
    *,
    coherence_arc_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only LOCK/SWAY coaching microline pair for future readability A/B experiments."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_COACH_MICROLINE_PAIR"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    arc = str(coherence_arc_signals.get("arc", "SWAY") or "SWAY").strip().upper()
    lock_line = "LOCK: Hold tempo; keep route calls crisp and deterministic."
    sway_line = "SWAY: Slow cadence; narrate one stabilizing action at a time."
    selected_line = lock_line if arc == "LOCK" else sway_line

    token = f"COHERENCE ARC COACH:{'LOCK' if arc == 'LOCK' else 'SWAY'}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "arc": arc,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias(
    *,
    coach_microline_pair_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact payload-only alias for coherence-arc coach microline selection (`CBGCFXWAC:<L|S>`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_COACH_MICROLINE_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    arc = str(coach_microline_pair_signals.get("arc", "SWAY") or "SWAY").strip().upper()
    alias = "L" if arc == "LOCK" else "S"
    token = f"CBGCFXWAC:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift(
    *,
    coach_microline_alias_signals: dict[str, object],
    prior_json_path: Path,
) -> tuple[str, dict[str, object]]:
    """Offline drift token for coach-line alias selection (`CBGCFXWAC DRIFT:<prev>><curr>`) with stale-prior guard."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_COACH_MICROLINE_ALIAS_DRIFT"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    current_alias = str(coach_microline_alias_signals.get("alias", "S") or "S").strip().upper()
    prior_alias = current_alias
    prior_loaded = False
    stale_prior_guard = False

    if prior_json_path.exists():
        try:
            prior_payload = json.loads(prior_json_path.read_text(encoding="utf-8"))
            prior_signals = prior_payload.get(
                "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasSignals",
                {},
            )
            if isinstance(prior_signals, dict):
                prior_alias = str(prior_signals.get("alias", current_alias) or current_alias).strip().upper()
                if prior_alias in {"L", "S"}:
                    prior_loaded = True
                else:
                    prior_alias = current_alias
                    stale_prior_guard = True
            else:
                stale_prior_guard = True
        except (json.JSONDecodeError, OSError, ValueError, TypeError):
            stale_prior_guard = True
    ...
    shifted = current_alias != prior_alias
    token = f"CBGCFXWAC DRIFT:{prior_alias}>{current_alias}"
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "priorAlias": prior_alias,
        "priorLoaded": prior_loaded,
        "stalePriorGuard": stale_prior_guard,
        "shifted": shifted,
        "token": token,
        "offlineOnly": True,
    }
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum(
    *,
    coach_microline_alias_drift_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline momentum token for coach-line alias transitions (`CBGCFXWAC MOMENTUM:LOCKED|WOBBLE`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_COACH_MICROLINE_ALIAS_MOMENTUM"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    shifted = bool(coach_microline_alias_drift_signals.get("shifted", False))
    prior_loaded = bool(coach_microline_alias_drift_signals.get("priorLoaded", False))
    stale_prior_guard = bool(coach_microline_alias_drift_signals.get("stalePriorGuard", False))

    momentum = "WOBBLE" if shifted and prior_loaded and not stale_prior_guard else "LOCKED"
    reason = "shifted_from_prior" if momentum == "WOBBLE" else "stable_or_stale_prior_guard"
    token = f"CBGCFXWAC MOMENTUM:{momentum}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat(
    *,
    world_tone_alias_signals: dict[str, object],
    coherence_momentum_signals: dict[str, object],
    coach_microline_alias_momentum_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compressed storybeat token from world-tone alias + coherence momentum + coach momentum (`CBGCFXWSB:<tone><coh><coach>`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    world_tone_alias = str(world_tone_alias_signals.get("alias", "N") or "N").strip().upper()
    if world_tone_alias not in {"S", "J", "B", "N"}:
        world_tone_alias = "N"

    coherence_momentum = str(coherence_momentum_signals.get("momentum", "STABLE") or "STABLE").strip().upper()
    coherence_alias_map = {
        "STABLE": "S",
        "WOBBLE": "W",
    }
    coherence_alias = coherence_alias_map.get(coherence_momentum, "S")

    coach_momentum = str(coach_microline_alias_momentum_signals.get("momentum", "LOCKED") or "LOCKED").strip().upper()
    coach_alias_map = {
        "LOCKED": "L",
        "WOBBLE": "W",
    }
    coach_alias = coach_alias_map.get(coach_momentum, "L")

    token = f"CBGCFXWSB:{world_tone_alias}{coherence_alias}{coach_alias}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "worldToneAlias": world_tone_alias,
        "coherenceMomentum": coherence_momentum,
        "coherenceAlias": coherence_alias,
        "coachMomentum": coach_momentum,
        "coachAlias": coach_alias,
        "storybeat": f"{world_tone_alias}{coherence_alias}{coach_alias}",
        "token": token,
        "offlineOnly": True,
    }


def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase(
    *,
    storybeat_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only storybeat phase alias from compressed storybeat momentum (`CBGCFXWSBP:C|T`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    coherence_momentum = str(storybeat_signals.get("coherenceMomentum", "STABLE") or "STABLE").strip().upper()
    coach_momentum = str(storybeat_signals.get("coachMomentum", "LOCKED") or "LOCKED").strip().upper()
    phase = "TENSE" if coherence_momentum == "WOBBLE" or coach_momentum == "WOBBLE" else "CALM"
    alias = "T" if phase == "TENSE" else "C"
    token = f"CBGCFXWSBP:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue(
    *,
    storybeat_phase_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only combat/VFX cue adapter from storybeat phase (`CBGCFXWSBP FX CUE:SOFT|EDGE`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    phase = str(storybeat_phase_signals.get("phase", "CALM") or "CALM").strip().upper()
    cue = "EDGE" if phase == "TENSE" else "SOFT"
    reason = "tense-phase" if phase == "TENSE" else "calm-phase"
    token = f"CBGCFXWSBP FX CUE:{cue}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias(
    *,
    storybeat_phase_fx_cue_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only compact alias mirror for storybeat phase FX cue (`CBGCFXWSBPFC:S|E`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_COMPACT_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    cue = str(storybeat_phase_fx_cue_signals.get("cue", "SOFT") or "SOFT").strip().upper()
    alias_map = {
        "SOFT": "S",
        "EDGE": "E",
    }
    alias = alias_map.get(cue, "S")
    token = f"CBGCFXWSBPFC:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity(
    *,
    storybeat_phase_fx_cue_compact_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only combat/VFX intensity hint from compact alias (`CBGCFXWSBPFCI:B|R`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_COMPACT_ALIAS_INTENSITY"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    alias = str(storybeat_phase_fx_cue_compact_alias_signals.get("alias", "S") or "S").strip().upper()
    intensity_map = {
        "S": "BASE",
        "E": "RAISED",
    }
    ...
    intensity = intensity_map.get(alias, "BASE")
    compact_alias = compact_alias_map[intensity]
    token = f"CBGCFXWSBPFCI:{compact_alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias(
    *,
    storybeat_phase_fx_cue_compact_alias_intensity_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only combat/VFX pulse alias from intensity (`CBGCFXWSBPFXP:S|P`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    intensity = str(storybeat_phase_fx_cue_compact_alias_intensity_signals.get("intensity", "BASE") or "BASE").strip().upper()
    alias_map = {
        "BASE": "S",
        "RAISED": "P",
    }
    alias = alias_map.get(intensity, "S")
    token = f"CBGCFXWSBPFXP:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair(
    *,
    storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact decode microline pair for `CBGCFXWSBPFXP` with DOS row-budget guardrails."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_DECODE_MICROLINE_PAIR"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    microline_pair = CBGCFXWSBPFXP_MICROLINE_LEGEND_MAP
    compact_token = "CBGCFXWSBPFXP MICRO:S=SOFT,P=PUSH"
    fallback_token = "CBGCFXWSBPFXP MICRO:S=SOFT pulse,P=PUSH pulse"
    dos_readability_row_budget_threshold = 48
    ...
    alias = str(storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals.get("alias", "S") or "S").strip().upper()
    selected = microline_pair["P"] if alias == "P" else microline_pair["S"]
    ...
    return (token if flag_enabled else "FLAG OFF"), {
        ...
        "selected": selected,
        "alias": alias,
        "legendVersion": CBGCFXWSBPFXP_MICROLINE_LEGEND_VERSION,
        "legendHash": CBGCFXWSBPFXP_MICROLINE_LEGEND_HASH,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_alias(
    *,
    ...
    phase_intent = str(intensity_pulse_language_variant_pack_signals.get("phaseIntent", "ANCHOR") or "ANCHOR").strip().upper()
    alias_map = {
        "ANCHOR": "A",
        "SURGE": "S",
    }
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_narration(
    *,
    intensity_pulse_language_variant_pack_signals: dict[str, object],
    coach_microline_alias_momentum_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline tri-state phase-intent narration variant (`ANCHOR|SURGE|RECOVER`) from pulse alias + momentum memory."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_LANGUAGE_VARIANT_PACK_PHASE_INTENT_NARRATION"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    phase_intent = str(intensity_pulse_language_variant_pack_signals.get("phaseIntent", "ANCHOR") or "ANCHOR").strip().upper()
    pulse_alias = str(intensity_pulse_language_variant_pack_signals.get("compactAlias", "S") or "S").strip().upper()
    coach_momentum = str(coach_microline_alias_momentum_signals.get("momentum", "LOCKED") or "LOCKED").strip().upper()

    if coach_momentum == "WOBBLE" and phase_intent == "ANCHOR":
        narration = "RECOVER"
        reason = "anchor-with-wobble-momentum"
    elif phase_intent == "SURGE":
        narration = "SURGE"
        reason = "surge-phase-intent"
    else:
        narration = "ANCHOR"
        reason = "stable-anchor"

    token = f"CBGCFXWSBPFXPI NARR:{narration}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint(
    *,
    intensity_pulse_language_variant_pack_phase_intent_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline compact rehearsal hint (`SOFT drill|SURGE drill`) from `CBGCFXWSBPFXPI` phase-intent alias.

    This is telemetry/copy-planning only and does not alter runtime balance.
    """
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_LANGUAGE_VARIANT_PACK_PHASE_INTENT_REHEARSAL_HINT"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}
    ...
    phase_intent_alias = str(intensity_pulse_language_variant_pack_phase_intent_alias_signals.get("alias", "A") or "A").strip().upper()

    if phase_intent == "SURGE" or phase_intent_alias == "S":
        drill_cue = "SURGE"
        rehearsal_hint = "SURGE drill"
        reason = "surge-phase-intent"
    else:
        drill_cue = "SOFT"
        rehearsal_hint = "SOFT drill"
        reason = "anchor-phase-intent"

    token = f"CBGCFXWSBPFXPI DRILL:{drill_cue}"
    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "phaseIntent": phase_intent,
        "phaseIntentAlias": phase_intent_alias,
        "drillCue": drill_cue,
        "rehearsalHint": rehearsal_hint,
        "reason": reason,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias(
    *,
    intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Payload-only compact alias for rehearsal cue (`CBGCFXWSBPFXPD:S|U`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_LANGUAGE_VARIANT_PACK_PHASE_INTENT_REHEARSAL_HINT_COMPACT_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    drill_cue = str(intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals.get("drillCue", "SOFT") or "SOFT").strip().upper()
    alias_map = {
        "SOFT": "S",
        "SURGE": "U",
    }
    alias = alias_map.get(drill_cue, "S")
    token = f"CBGCFXWSBPFXPD:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary(
    *,
    intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline rehearsal microline vocabulary pack keyed by `CBGCFXWSBPFXPD` (`S|U`) with DOS budget guardrails."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_LANGUAGE_VARIANT_PACK_PHASE_INTENT_REHEARSAL_HINT_COMPACT_ALIAS_MICROLINE"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    alias = str(intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals.get("alias", "S") or "S").strip().upper()
    if alias not in {"S", "U"}:
        alias = "S"

    microline_pair = CBGCFXWSBPFXPD_MICROLINE_LEGEND_MAP
    selected = microline_pair["U"] if alias == "U" else microline_pair["S"]

    compact_token = "CBGCFXWSBPFXPD MICRO:S=SOFT drill,U=SURGE drill"
    fallback_token = "CBGCFXWSBPFXPD MICRO:S=SOFT drill: hold pace and rehearse one stable line.,U=SURGE drill: tighten cadence and rehearse one urgent verb."
    dos_readability_row_budget_threshold = 56
    dos_row_budget_within_threshold = len(compact_token) <= dos_readability_row_budget_threshold
    token = compact_token if dos_row_budget_within_threshold else fallback_token
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action(
    *,
    intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Game Director vertical slice: map `CBGCFXWSBPFXPD` alias to a compact rehearsal coach action token."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_INTENSITY_PULSE_LANGUAGE_VARIANT_PACK_PHASE_INTENT_REHEARSAL_HINT_COMPACT_ALIAS_COACH_ACTION"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}
    ...
    action = action_map.get(alias, "PACE")
    token = f"CBGCFXWSBPFXPD COACH:{action}"

    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "alias": alias if alias in {"S", "U"} else "S",
        "action": action,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_phase_echo_mutation(
    *,
    intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals: dict[str, object],
    world_tone_drift_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline-only experiment: mutate rehearsal hint flavor using prior-beat alias drift memory."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_INTENT_REHEARSAL_PHASE_ECHO_MUTATION"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    rehearsal_alias = str(intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals.get("alias", "S") or "S").strip().upper()
    if rehearsal_alias not in {"S", "U"}:
        rehearsal_alias = "S"

    shifted = bool(world_tone_drift_signals.get("shifted", False))
    prior_alias = str(world_tone_drift_signals.get("priorAlias", "C") or "C").strip().upper()
    current_alias = str(world_tone_drift_signals.get("currentAlias", "C") or "C").strip().upper()
    prior_loaded = bool(world_tone_drift_signals.get("priorLoaded", False))

    if not shifted:
        mutation = "STEADY"
        reason = "no-alias-drift"
    elif rehearsal_alias == "U":
        mutation = "SURGE_ECHO"
        reason = "drift-plus-surge"
    else:
        mutation = "ANCHOR_ECHO"
        reason = "drift-plus-soft"

    token = f"CBGCFXWSBPFXPD ECHO:{mutation}"

    return (token if flag_enabled else "FLAG OFF"), {
        "flagName": flag_name,
        "flagEnabled": flag_enabled,
        "rehearsalAlias": rehearsal_alias,
        "mutation": mutation,
        "reason": reason,
        "priorAlias": prior_alias,
        "currentAlias": current_alias,
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair(
    *,
    ...
    """Offline copy microline pair for intensity states (`BASE|RAISED`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_STORYBEAT_PHASE_FX_CUE_COMPACT_ALIAS_INTENSITY_COACH_MICROLINE_PAIR"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    intensity = str(storybeat_phase_fx_cue_compact_alias_intensity_signals.get("intensity", "BASE") or "BASE").strip().upper()
    microline_pair = {
        "BASE": "BASE: Keep copy grounded; one stable callout per beat.",
        "RAISED": "RAISED: Tighten copy tempo; foreground urgent action verbs.",
    }
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_copy_variant_recommendation_reason_priority_alias(
    *,
    coach_copy_variant_recommendation_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Compact digest alias for reasonPriority (`CBGCFXWACRP:P1|P2|P3|P4`)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ARC_COACH_COPY_VARIANT_REC_REASON_PRIORITY_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}

    reason_priority = str(coach_copy_variant_recommendation_signals.get("reasonPriority", "P4") or "P4").strip().upper()
    alias_map = {
        "P1": "P1",
        "P2": "P2",
        "P3": "P3",
    ...
    alias = alias_map.get(reason_priority, "P4")
    token = f"CBGCFXWACRP:{alias}"
...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_alias(
    *,
    ...
    """Compact alias for CBGCFXW coherence status (payload-only)."""
    flag_name = "DOTPIO_EXPERIMENT_CADENCE_BRIDGE_GLYPH_CONF_FX_PULSE_MICROCOPY_WORLD_TONE_COHERENCE_ALIAS"
    flag_value = os.environ.get(flag_name, "")
    flag_enabled = flag_value.strip().lower() in {"1", "true", "yes", "on"}
    ...
    alias = alias_map.get(status, "O")
    token = f"CBGCFXWC:{alias}"
    ...
    *,
    ...
    if prior_json_path.exists():
        try:
            prior_payload = json.loads(prior_json_path.read_text(encoding="utf-8"))
            prior_alias = str(
                prior_payload.get("comboConfidenceFxCoachCueWhyAlias")
                or prior_payload.get("dmgComboConfidenceFxCoachCueWhyAlias")
                or prior_alias
            ).strip().upper() or prior_alias
            prior_loaded = True
        except Exception:
            prior_loaded = False
...
def combo_confidence_fx_coach_cue_why_scene_palette_family_trend_from_prior(
    *,
    ...
    """Track DCCFXCW scene-palette family net drift vs prior digest window."""
    ...
    if prior_json_path.is_file():
        try:
            ...
            prior_family = prior_families.get("dmgComboConfidenceFxCoachCueWhyScenePaletteAlias", {}) if isinstance(prior_families, dict) else {}
    ...
    if drift > 0:
        trend = "HEATING"
        reason = "scene-palette-family-net-increased-vs-prior-window"
    elif drift < 0:
        trend = "COOLING"
        reason = "scene-palette-family-net-decreased-vs-prior-window"
    else:
        trend = "STABLE"
...
def combo_confidence_fx_coach_cue_why_scene_pulse_arc_from_signals(
    *,
    scene_pulse: str,
    scene_pulse_signals: dict[str, object],
    scene_palette_trend_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Digest-only narrative pulse-arc companion token for scene pacing triage."""
    pulse_value = str(scene_pulse).strip().upper()
    ...
    elif pulse == "SURGE" and trend == "HEATING":
        arc = "ERUPT"
        reason = "surge-plus-heating-trend-drives-erupt-arc"
    elif pulse == "SURGE" and regime == "SPIKE":
        arc = "ERUPT"
        reason = "surge-with-spike-regime-drives-erupt-arc"
    else:
        arc = "BRACE"
...
def combo_confidence_fx_coach_cue_why_scene_pulse_arc_copy_from_signals(
    *,
    scene_pulse_arc: str,
    scene_pulse_arc_signals: dict[str, object],
    fx_accent_trend_signals: dict[str, object],
) -> tuple[str, dict[str, object]]:
    """Offline arc-to-copy recommendation token for digest-only triage."""
    arc_value = str(scene_pulse_arc).strip().upper()
    arc = arc_value.split(":", 1)[1] if ":" in arc_value else "BRACE"
    ...
    elif arc == "RECOVER" or trend == "DOWN":
        copy = "CLEAR"
        reason = "recover-arc-or-falling-trend-drives-clear-copy"
    else:
        copy = "HOLD"
...
def combo_confidence_fx_coach_cue_why_scene_pulse_arc_copy_alt_from_signals(
    *,
    scene_pulse_arc_copy: str,
    scene_pulse_arc_copy_signals: dict[str, object],
    pulse_remap_momentum_suppression: str,
    pulse_remap_suppression_escalation_plan: str,
) -> tuple[str, dict[str, object]]:
    """Fallback copy token for surge-vs-suppression mismatch windows (digest-only)."""
    copy_value = str(scene_pulse_arc_copy).strip().upper()
    ...
    if mismatch_window:
        alt = "HOLD"
        reason = "surge-copy-mismatches-suppression-window-fallback-hold"
    elif copy == "CLEAR" and suppression == "SUPPRESS":
        alt = "HOLD"
        reason = "clear-copy-buffered-during-active-suppression"
    else:
        alt = copy
    ...
    return f"DCCFXCPA COPY ALT:{alt}", {
        ...
        "suppressionPlan": suppression_plan,
...
def main() -> int:
    ...
    combat_vfx_cadence_coach_token, combat_vfx_cadence_coach_signals = combat_vfx_cadence_coach(
    ...
    combat_vfx_cadence_coach_alias_token, combat_vfx_cadence_coach_alias_signals = resolve_combat_vfx_cadence_coach_alias(
        coach_token=combat_vfx_cadence_coach_token,
    )
    combat_vfx_cadence_coach_why_hysteresis_alias_token, combat_vfx_cadence_coach_why_hysteresis_alias_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_alias(
        coach_why_signals=combat_vfx_cadence_coach_why_signals,
    )
    combat_vfx_cadence_coach_why_hysteresis_recommendation_token, combat_vfx_cadence_coach_why_hysteresis_recommendation_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_recommendation_alias(
        coach_why_signals=combat_vfx_cadence_coach_why_signals,
        lane_cadence_miss_risk_signals=lane_cadence_miss_risk_signals,
    )
    ...
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation(
        coach_why_signals=combat_vfx_cadence_coach_why_signals,
        recommendation_confidence_signals=combat_vfx_cadence_coach_why_hysteresis_recommendation_confidence_signals,
        lane_cadence_miss_risk_signals=lane_cadence_miss_risk_signals,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_alias_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_alias_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_alias(
        recommendation_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_token,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse(
    ...
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_recommendation(
        lane_cadence_miss_risk_signals=lane_cadence_miss_risk_signals,
        recommendation_confidence_signals=combat_vfx_cadence_coach_why_hysteresis_recommendation_confidence_signals,
        legend_variant_confidence_signals=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias(
        copy_pack_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend(
        copy_pack_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token,
        lane_cadence_miss_risk_signals=lane_cadence_miss_risk_signals,
        prior_json_path=args.out_json,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias(
        trend_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence(
        trend_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token,
        trend_signals=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals,
    )
    combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_token, combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_signals = resolve_combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_note(
        trend_token=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token,
        trend_confidence_signals=combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals,
        prior_json_path=args.out_json,
    )
    ...
    cadence_bridge_glyph_confidence_token, cadence_bridge_glyph_confidence_signals = cadence_bridge_glyph_confidence_from_gap_volatility(
    ...
    cadence_bridge_glyph_confidence_legend_compact_alias = (
        "CBGCL:LMH" if cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"] else "FLAG OFF"
    )
    cadence_bridge_glyph_confidence_legend_compact_alias_signals = {
        ...
        "alias": "LMH",
        "aliasToken": "CBGCL:LMH",
    }
    cadence_bridge_glyph_confidence_narrative_map = {
        "LOW": "spike",
        "MID": "swing",
        "HIGH": "steady",
    }
    cadence_bridge_glyph_confidence_narrative = cadence_bridge_glyph_confidence_narrative_map.get(
        cadence_bridge_glyph_confidence_signals.get("confidence", ""),
        "unknown",
    )
    cadence_bridge_glyph_confidence_intent_cue_map = {
        "steady": "H",
        "swing": "P",
        "spike": "T",
        "unknown": "U",
    }
    cadence_bridge_glyph_confidence_intent_cue = cadence_bridge_glyph_confidence_intent_cue_map.get(
    ...
    cadence_bridge_glyph_confidence_intent_tone_pack_compact_alias = (
        "CBGCI:HPTU" if cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"] else "FLAG OFF"
    )
    cadence_bridge_glyph_confidence_intent_tone_pack_compact_alias_signals = {
        "flagName": cadence_bridge_glyph_confidence_compact_alias_signals["flagName"],
        "flagEnabled": cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"],
        "alias": "HPTU",
        "aliasToken": "CBGCI:HPTU",
        "cue": cadence_bridge_glyph_confidence_intent_cue,
        "current": cadence_bridge_glyph_confidence_narrative,
    }
    cadence_bridge_glyph_confidence_intent_tone_pack_legend_compact_alias = (
        "CBGCIL:HPTU" if cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"] else "FLAG OFF"
    )
    cadence_bridge_glyph_confidence_intent_tone_pack_legend_compact_alias_signals = {
        "flagName": cadence_bridge_glyph_confidence_compact_alias_signals["flagName"],
        "flagEnabled": cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"],
        "alias": "HPTU",
        "aliasToken": "CBGCIL:HPTU",
    }
    cadence_bridge_glyph_confidence_intent_tone_pack_active_alias = (
        f"CBGCIA:{cadence_bridge_glyph_confidence_intent_cue}"
        if cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"]
        else "FLAG OFF"
    )
    cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals = {
        "flagName": cadence_bridge_glyph_confidence_compact_alias_signals["flagName"],
        "flagEnabled": cadence_bridge_glyph_confidence_compact_alias_signals["flagEnabled"],
        "cue": cadence_bridge_glyph_confidence_intent_cue,
        "current": cadence_bridge_glyph_confidence_narrative,
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint, cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint(
        fx_pulse_signals=cadence_bridge_glyph_confidence_fx_pulse_signals,
        narrative_signals=cadence_bridge_glyph_confidence_narrative_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias(
        microcopy_hint_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias(
        microcopy_hint_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals,
    )
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum(
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc(
        coherence_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_signals,
        coherence_momentum_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias(
        coherence_arc_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair(
        coherence_arc_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias(
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_legend = (
        "L=LOCK,S=SWAY"
        if cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals["flagEnabled"]
        else "FLAG OFF"
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift(
        coach_microline_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals,
        prior_json_path=args.out_json,
    )
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat(
        world_tone_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals,
        coherence_momentum_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_momentum_signals,
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase(
        storybeat_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue(
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias(
        storybeat_phase_fx_cue_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity(
        storybeat_phase_fx_cue_compact_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals,
    )
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_alias(
        intensity_pulse_language_variant_pack_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_narration, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_narration_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_narration(
        intensity_pulse_language_variant_pack_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_signals,
        coach_microline_alias_momentum_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint(
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias(
        intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary(
        intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action(
        intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals,
    )
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_phase_echo_mutation, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_phase_echo_mutation_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_phase_echo_mutation(
        intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals,
        world_tone_drift_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_drift_signals,
    )
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair(
        storybeat_phase_fx_cue_compact_alias_intensity_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals,
    )
    ...
    cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_copy_variant_recommendation_reason_priority_alias, cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_copy_variant_recommendation_reason_priority_alias_signals = resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_copy_variant_recommendation_reason_priority_alias(
        coach_copy_variant_recommendation_signals=cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_copy_variant_recommendation_signals,
    )
    ...
    combo_confidence_fx_volatility_regime = str(combo_confidence_fx_accent_signals.get('volatilityRegime', 'CALM')).upper()
    dmg_combo_conf_fx_accent_volatility_alias = f"DCCFXV:{volatility_alias_map.get(combo_confidence_fx_volatility_regime, 'C')}"
    dmg_combo_conf_fx_coach_cue_alias_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_ALIAS"
    dmg_combo_conf_fx_coach_cue_alias_flag_enabled = os.environ.get(dmg_combo_conf_fx_coach_cue_alias_flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    dmg_combo_conf_fx_coach_cue_alias = "DCCFXC:M"
    dmg_combo_conf_fx_coach_cue_mode = "MUTE"
    ...
    coach_copy_why_short = str(lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals.get("short", "BASELINE WATCH") or "BASELINE WATCH").upper()
    if combo_confidence_fx_volatility_regime == "SPIKE" or "SPIKE" in coach_copy_why_short:
        dmg_combo_conf_fx_coach_cue_alias = "DCCFXC:H"
        dmg_combo_conf_fx_coach_cue_mode = "HOT"
    elif combo_confidence_fx_volatility_regime == "SWING" or "FLEX" in coach_copy_why_short or "SHIFT" in coach_copy_why_short:
        dmg_combo_conf_fx_coach_cue_alias = "DCCFXC:T"
        dmg_combo_conf_fx_coach_cue_mode = "TENSE"
    else:
        dmg_combo_conf_fx_coach_cue_alias = "DCCFXC:M"
        dmg_combo_conf_fx_coach_cue_mode = "MUTE"
    coach_copy_why_alias_map = {
        "HOLD RESET": "R",
        "REGIME SHIFT": "S",
        "FLEX WATCH": "F",
        "BASELINE WATCH": "B",
    ...
    dmg_combo_conf_fx_coach_cue_why_alias_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_ALIAS"
    dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled = os.environ.get(dmg_combo_conf_fx_coach_cue_why_alias_flag_name, "").strip().lower() in {"1", "true", "yes", "on"}
    dmg_combo_conf_fx_coach_cue_why_alias = f"DCCFXCW:{coach_copy_why_alias_map.get(coach_copy_why_short, 'B')}"
    dmg_combo_conf_fx_coach_cue_why_scene_palette_hint, dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_signals = combo_confidence_fx_coach_cue_why_scene_palette_hint_from_signals(
        coach_cue_why_alias=dmg_combo_conf_fx_coach_cue_why_alias,
        prior_json_path=args.out_json,
    )
    dmg_combo_conf_fx_coach_cue_why_scene_palette_family_trend_drift, dmg_combo_conf_fx_coach_cue_why_scene_palette_family_trend_signals = combo_confidence_fx_coach_cue_why_scene_palette_family_trend_from_prior(
        current_family_totals=token_family_totals["dmgComboConfidenceFxCoachCueWhyScenePaletteAlias"],
        prior_json_path=args.out_json,
    )
    dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_SCENE_PALETTE"
    dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_flag_enabled = os.environ.get(
    ...
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc, dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals = combo_confidence_fx_coach_cue_why_scene_pulse_arc_from_signals(
        scene_pulse=dmg_combo_conf_fx_coach_cue_why_scene_pulse,
        scene_pulse_signals=dmg_combo_conf_fx_coach_cue_why_scene_pulse_signals,
        scene_palette_trend_signals=dmg_combo_conf_fx_coach_cue_why_scene_palette_family_trend_signals,
    )
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_SCENE_PULSE_ARC"
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled = os.environ.get(
        dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name,
        "",
    ).strip().lower() in {"1", "true", "yes", "on"}
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias = resolve_combo_confidence_fx_coach_cue_why_scene_pulse_arc_alias(
        dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc,
    )
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_SCENE_PULSE_ARC_ALIAS"
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled = os.environ.get(
        dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name,
        "",
    ).strip().lower() in {"1", "true", "yes", "on"}
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy, dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_signals = combo_confidence_fx_coach_cue_why_scene_pulse_arc_copy_from_signals(
        scene_pulse_arc=dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc,
        scene_pulse_arc_signals=dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals,
        fx_accent_trend_signals=combo_confidence_fx_accent_family_trend_signals,
    )
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_SCENE_PULSE_ARC_COPY"
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_enabled = os.environ.get(
        dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_name,
        "",
    ).strip().lower() in {"1", "true", "yes", "on"}
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt_flag_name = "DOTPIO_EXPERIMENT_DMG_COMBO_CONF_FX_COACH_CUE_WHY_SCENE_PULSE_ARC_COPY_ALT"
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt_flag_enabled = os.environ.get(
    ...
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_family_trend_drift, dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_family_trend_signals = combo_confidence_fx_accent_family_trend_from_prior(
        current_family_totals=token_family_totals["dmgComboConfidenceFxCoachCueWhyScenePulseArcCopyAlias"],
        prior_json_path=args.out_json,
    )
    ...
    dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt, dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt_signals = combo_confidence_fx_coach_cue_why_scene_pulse_arc_copy_alt_from_signals(
        scene_pulse_arc_copy=dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy,
    ...
    payload = {
        ...
        "combatVfxCadenceCoach": combat_vfx_cadence_coach_token,
        "combatVfxCadenceCoachSignals": combat_vfx_cadence_coach_signals,
        "combatVfxCadenceCoachWhy": combat_vfx_cadence_coach_why_token,
        "combatVfxCadenceCoachWhySignals": combat_vfx_cadence_coach_why_signals,
        "combatVfxCadenceCoachWhyAlias": combat_vfx_cadence_coach_why_alias_token,
        "combatVfxCadenceCoachWhyAliasSignals": combat_vfx_cadence_coach_why_alias_signals,
        "combatVfxCadenceCoachWhyHysteresisAlias": combat_vfx_cadence_coach_why_hysteresis_alias_token,
        ...
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorRecommendation": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorRecommendationSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorRecommendationAlias": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_recommendation_alias_token,
        ...
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPack": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackAlias": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackAliasSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrend": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendAlias": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendAliasSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendConfidence": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendConfidenceSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendConfidenceOverride": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_token,
        "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackTrendConfidenceOverrideSignals": combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_override_signals,
        ...
        "cadenceBridgeGlyphConfidenceLegendCompactAlias": cadence_bridge_glyph_confidence_legend_compact_alias,
        ...
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackCompactAlias": cadence_bridge_glyph_confidence_intent_tone_pack_compact_alias,
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackCompactAliasSignals": cadence_bridge_glyph_confidence_intent_tone_pack_compact_alias_signals,
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias": cadence_bridge_glyph_confidence_intent_tone_pack_active_alias,
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAliasSignals": cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals,
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackLegendCompactAlias": cadence_bridge_glyph_confidence_intent_tone_pack_legend_compact_alias,
        "cadenceBridgeGlyphConfidenceNarrativeIntentTonePackLegendCompactAliasSignals": cadence_bridge_glyph_confidence_intent_tone_pack_legend_compact_alias_signals,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHint": cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAliasSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArc": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcAliasSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolinePair": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolinePairSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasLegend": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_legend,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasLegendSignals": {
            "flagName": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals["flagName"],
            "flagEnabled": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals["flagEnabled"],
            "legend": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_legend,
            "offlineOnly": True,
        },
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasDrift": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCue": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueCompactAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueCompactAliasSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueCompactAliasIntensity": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHint": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAlias": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasMicrolineVocabulary": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasMicrolineVocabularySignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasMicrolineVocabularyLegendVersion": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals["legendVersion"],
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasMicrolineVocabularyLegendHash": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals["legendHash"],
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasCoachAction": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintCompactAliasCoachActionSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_coach_action_signals,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseLanguageVariantPackPhaseIntentRehearsalHintPhaseEchoMutationSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_phase_echo_mutation_signals,
        ...
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueIntensityPulseDecodeMicrolinePairLegendHash": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals["legendHash"],
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueCompactAliasIntensityCoachMicrolinePair": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair,
        "cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhaseFxCueCompactAliasIntensityCoachMicrolinePairSignals": cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_coach_microline_pair_signals,
        ...
        "dmgComboConfidenceFxCoachCueAlias": dmg_combo_conf_fx_coach_cue_alias,
        "dmgComboConfidenceFxCoachCueAliasSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_alias_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_alias_flag_enabled,
            "alias": dmg_combo_conf_fx_coach_cue_alias,
            "mode": dmg_combo_conf_fx_coach_cue_mode,
            "volatilityRegime": combo_confidence_fx_volatility_regime,
            "coachCopyWhyShort": lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals["short"],
            "offlineOnly": True,
        },
        "dmgComboConfidenceFxCoachCueWhyAlias": dmg_combo_conf_fx_coach_cue_why_alias,
        "dmgComboConfidenceFxCoachCueWhyAliasSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_alias_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled,
            "alias": dmg_combo_conf_fx_coach_cue_why_alias,
            "coachCopyWhyShort": lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals["short"],
            "offlineOnly": True,
        },
        "dmgComboConfidenceFxCoachCueWhyScenePaletteHint": dmg_combo_conf_fx_coach_cue_why_scene_palette_hint,
        "dmgComboConfidenceFxCoachCueWhyScenePaletteHintSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_flag_enabled,
            **dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_signals,
        },
        ...
        "dmgComboConfidenceFxCoachCueWhyScenePulseArc": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc,
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled,
            **dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals,
        },
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcAlias": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias,
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcAliasSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled,
            "arc": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals["arc"],
            "alias": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias,
            "offlineOnly": True,
        },
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcCopy": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy,
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcCopySignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_name,
            "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_enabled,
            **dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_signals,
        },
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcCopyAlt": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt,
        "dmgComboConfidenceFxCoachCueWhyScenePulseArcCopyAltSignals": {
            "flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_alt_flag_name,
        ...
        "comboConfidenceFxCoachCueWhyScenePaletteHint": dmg_combo_conf_fx_coach_cue_why_scene_palette_hint if dmg_combo_conf_fx_coach_cue_why_scene_palette_hint_flag_enabled else "FLAG OFF",
        ...
        "comboConfidenceFxCoachCueWhyScenePulseArc": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled else "FLAG OFF",
        "comboConfidenceFxCoachCueWhyScenePulseArcSignals": {"flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name, "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled, **dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals},
        "comboConfidenceFxCoachCueWhyScenePulseArcAlias": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled else "FLAG OFF",
        "comboConfidenceFxCoachCueWhyScenePulseArcAliasSignals": {"flagName": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name, "flagEnabled": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled, "arc": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals["arc"], "alias": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias, "offlineOnly": True},
        "comboConfidenceFxCoachCueWhyScenePulseArcCopy": dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_copy_flag_enabled else "FLAG OFF",
    ...
    md = [
        ...
        f"- DCCFXC: **{dmg_combo_conf_fx_coach_cue_alias if dmg_combo_conf_fx_coach_cue_alias_flag_enabled else 'FLAG OFF'}** (flag={dmg_combo_conf_fx_coach_cue_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_alias_flag_enabled} mode={dmg_combo_conf_fx_coach_cue_mode} why={lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals['short']} regime={combo_confidence_fx_volatility_regime})",
        f"- DCCFXCW: **{dmg_combo_conf_fx_coach_cue_why_alias if dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled else 'FLAG OFF'}** (flag={dmg_combo_conf_fx_coach_cue_why_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled} why={lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals['short']})",
        ...
        f"- DCCFXCW SCENE PULSE ARC: **{dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled else 'FLAG OFF'}** (flag={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled} pulse={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['pulse']} trend={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['trend']} regime={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['volatilityRegime']} reason={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['reason']})",
        "- DCCFXCW SCENE PULSE ARC LEGEND: RECOVER=SOFT RESET, BRACE=MIXED HOLD, ERUPT=SURGE+HEATING",
        f"- DCCFXCPA: **{dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled else 'FLAG OFF'}** (flag={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled} arc={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['arc']})",
        ...
        f"- CVCWHR FX LEGEND REC + CVCWHR FX LEGEND REC CONF FAMILY CHURN: **net {(token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['net'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['net']):+d}** (added={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['added'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['added']} removed={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['removed'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['removed']} churn={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['churn'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['churn']} coverage={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['coverage']}+{token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['coverage']})",
        f"- CVCWHR FX LEGEND COPY PACK: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token}** (pack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['pack']} risk={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['risk']} Δ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['deltaHours']:+.1f}h volatility={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['volatility']} confidence={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['confidence']} reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['reason']} offlineOnly={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['offlineOnly']})",
        f"- CVCWHR FX LEGEND CP: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_token}** (flag={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['flagName']} enabled={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['flagEnabled']} copyPack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['copyPackToken']} alias={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['alias']})",
        f"- CVCWHR FX LEGEND COPY PACK TREND: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token}** (trend={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['trend']} pack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['copyPack']} priorPack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorCopyPack']} Δ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['deltaHours']:+.1f}h priorΔ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorDeltaHours']:+.1f}h shift={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['momentumShiftHours']:+.1f}h loaded={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorLoaded']} reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['reason']})",
        f"- CVCWHR FX LEGEND CPT: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_token}** (flag={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['flagName']} enabled={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['flagEnabled']} trend={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['trend']} alias={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['alias']})",
        f"- CVCWHR FX LEGEND COPY PACK TREND CONF: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_token}** (confidence={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['confidence']} trend={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['trend']} priorLoaded={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['priorLoaded']} shift={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['momentumShiftHours']:+.1f}h reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['reason']})",
        f"- CVCWHR FX LEGEND CPTC: **{combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['aliasToken']}** (flag={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['flagName']} enabled={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['flagEnabled']} confidence={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['confidence']} alias={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_confidence_signals['alias']})",
        ...
        f"- CBGCIA: **{cadence_bridge_glyph_confidence_intent_tone_pack_active_alias}** (flag={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['flagEnabled']} cue={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['cue']} current={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['current']} alias={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['aliasToken']})",
        f"- CBGCIA FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['coverage']})",
        f"- CBGCFXR: **{cadence_bridge_glyph_confidence_fx_pulse_regime_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['flagEnabled']} alias={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['aliasToken']} regime={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['volatilityRegime']})",
        f"- CBGCFXR FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['coverage']})",
        f"- CBGCFXA: **{cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['flagEnabled']} alias={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['aliasToken']} mode={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['aggressivenessMode']})",
        f"- CBGCFXA FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['coverage']})",
        f"- CBGC FX HINT: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['flagEnabled']} mode={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['aggressivenessMode']} pulse={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['resolvedPulse']})",
        f"- CBGC FX HINT FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['coverage']})",
        f"- CBGCFXH: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['flagEnabled']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['aliasToken']} mode={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['aggressivenessMode']})",
        f"- CBGCFXH FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['coverage']})",
        ...
        f"- COHERENCE ARC: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['flagEnabled']} arc={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['arc']} source={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['arcSource']} momentum={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['momentum']} driftStreak={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_signals['driftStreak']})",
        f"- COHERENCE ARC COACH: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals['flagEnabled']} arc={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals['arc']} selected={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_pair_signals['selected']})",
        f"- CVARC: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals['flagEnabled']} arc={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals['arc']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_alias_signals['alias']})",
        f"- CBGCFXWAC: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['flagEnabled']} arc={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['arc']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['alias']})",
        f"- CBGCFXWAC LEGEND: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_legend}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_signals['flagEnabled']} decode=L:LOCK,S:SWAY)",
        f"- CBGCFXWAC DRIFT: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals['flagEnabled']} prior={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals['priorAlias']} current={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals['currentAlias']} shifted={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_drift_signals['shifted']})",
        f"- CBGCFXWAC MOMENTUM: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['flagEnabled']} momentum={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['momentum']} shifted={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['shifted']} priorLoaded={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['priorLoaded']} reason={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_coach_microline_alias_momentum_signals['reason']})",
        f"- CBGCFXWAC MOMENTUM FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcCoachMicrolineAliasMomentum']['coverage']})",
        f"- CBGCFXWSB: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['flagEnabled']} beat={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['storybeat']} worldTone={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['worldToneAlias']} coherence={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['coherenceMomentum']} coach={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_signals['coachMomentum']})",
        f"- CBGCFXWSB FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeat']['coverage']})",
        f"- CBGCFXWSBP: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['flagEnabled']} phase={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['phase']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['alias']} coherence={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['coherenceMomentum']} coach={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_signals['coachMomentum']})",
        f"- CBGCFXWSBP FAMILY CHURN: **net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase']['net']:+d}** (added={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase']['added']} removed={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase']['removed']} churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyWorldToneCoherenceArcStorybeatPhase']['coverage']})",
        f"- CBGCFXWSBP FX CUE: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals['flagEnabled']} phase={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals['phase']} cue={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals['cue']} reason={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_signals['reason']})",
        f"- CBGCFXWSBPFC: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals['flagEnabled']} cue={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals['cue']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_signals['alias']})",
        f"- CBGCFXWSBPFCI: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals['flagEnabled']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals['alias']} intensity={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals['intensity']} compactAlias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_signals['compactAlias']})",
        f"- CBGCFXWSBPFXP: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals['flagEnabled']} intensity={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals['intensity']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_compact_alias_intensity_pulse_alias_signals['alias']})",
        f"- CBGCFXWSBPFXP MICROLINE: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals['flagEnabled']} selected={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals['selected']} rowBudget<={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals['dosReadabilityRowBudgetThreshold']} within={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_decode_microline_pair_signals['dosRowBudgetWithinThreshold']})",
        ...
        f"- CBGCFXWSBPFXPD MICROLINE: **{cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary}** (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['flagName']} enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['flagEnabled']} alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['alias']} selected={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['selected']} rowBudget<={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['dosReadabilityRowBudgetThreshold']} within={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_coherence_arc_storybeat_phase_fx_cue_intensity_pulse_language_variant_pack_phase_intent_rehearsal_hint_compact_alias_microline_vocabulary_signals['dosRowBudgetWithinThreshold']})",
        f"- CBGCFXWSBPFXPD MICROLINE LEGEND: S=SOFT drill: hold pace and rehearse one stable line., U=SURGE drill: tighten cadence and rehearse one urgent verb. (v={CBGCFXWSBPFXPD_MICROLINE_LEGEND_VERSION} hash={CBGCFXWSBPFXPD_MICROLINE_LEGEND_HASH})",
    ...
    md.extend([
        ...
        f"- DCCFXC ALIAS: {dmg_combo_conf_fx_coach_cue_alias if dmg_combo_conf_fx_coach_cue_alias_flag_enabled else 'FLAG OFF'} (mode={dmg_combo_conf_fx_coach_cue_mode} why={lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals['short']} regime={combo_confidence_fx_volatility_regime} flag={dmg_combo_conf_fx_coach_cue_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_alias_flag_enabled})",
        f"- DCCFXCW ALIAS: {dmg_combo_conf_fx_coach_cue_why_alias if dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled else 'FLAG OFF'} (why={lane_priority_recommendation_confidence_guard_persistence_coach_copy_why_signals['short']} flag={dmg_combo_conf_fx_coach_cue_why_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_alias_flag_enabled})",
        ...
        "- DCCFXCW SCENE PULSE LEGEND: SOFT=COOL+CALM, HARD=MIXED PRESSURE, SURGE=SCAR|SPIKE",
        f"- DCCFXCW SCENE PULSE ARC: {dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled else 'FLAG OFF'} (pulse={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['pulse']} trend={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['trend']} regime={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['volatilityRegime']} reason={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['reason']} flag={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_flag_enabled})",
        "- DCCFXCW SCENE PULSE ARC LEGEND: RECOVER=SOFT RESET, BRACE=MIXED HOLD, ERUPT=SURGE+HEATING",
        f"- DCCFXCPA: {dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias if dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled else 'FLAG OFF'} (arc={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_signals['arc']} flag={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_name} enabled={dmg_combo_conf_fx_coach_cue_why_scene_pulse_arc_alias_flag_enabled})",
        "- DCCFXCPA LEGEND: R=RECOVER, B=BRACE, E=ERUPT",
        ...
        f"- DCCFXC FAMILY CHURN: +{token_family_totals['dmgComboConfidenceFxCoachCueAlias']['added']} / -{token_family_totals['dmgComboConfidenceFxCoachCueAlias']['removed']} / net {token_family_totals['dmgComboConfidenceFxCoachCueAlias']['net']} (churn={token_family_totals['dmgComboConfidenceFxCoachCueAlias']['churn']} coverage={token_family_totals['dmgComboConfidenceFxCoachCueAlias']['coverage']})",
        f"- DCCFXCW FAMILY CHURN: +{token_family_totals['dmgComboConfidenceFxCoachCueWhyAlias']['added']} / -{token_family_totals['dmgComboConfidenceFxCoachCueWhyAlias']['removed']} / net {token_family_totals['dmgComboConfidenceFxCoachCueWhyAlias']['net']} (churn={token_family_totals['dmgComboConfidenceFxCoachCueWhyAlias']['churn']} coverage={token_family_totals['dmgComboConfidenceFxCoachCueWhyAlias']['coverage']})",
        ...
        f"- CVCWHR FX LEGEND REC: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_token} (variant={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['variant']}, risk={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['risk']}, volatility={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['volatility']}, pulse={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['pulse']}, reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['reason']}, offlineOnly={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_recommendation_signals['offlineOnly']})",
        f"- CVCWHR FX LEGEND REC CONF: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_token} (confidence={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['confidence']}, variant={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['variant']}, risk={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['risk']}, volatility={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['volatility']}, reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['reason']}, offlineOnly={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_variant_confidence_signals['offlineOnly']})",
        f"- CVCWHR FX LEGEND REC + CVCWHR FX LEGEND REC CONF FAMILY CHURN: +{token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['added'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['added']} / -{token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['removed'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['removed']} / net {token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['net'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['net']} (churn={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['churn'] + token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['churn']} coverage={token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantRecommendationAlias']['coverage']}+{token_family_totals['combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendVariantConfidenceAlias']['coverage']})",
        f"- CVCWHR FX LEGEND COPY PACK: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_token} (pack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['pack']}, risk={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['risk']}, Δ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['deltaHours']:+.1f}h, volatility={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['volatility']}, confidence={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['confidence']}, reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['reason']}, offlineOnly={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_signals['offlineOnly']})",
        f"- CVCWHR FX LEGEND CP: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_token} (flag={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['flagName']}, enabled={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['flagEnabled']}, copyPack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['copyPackToken']}, alias={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_alias_signals['alias']})",
        f"- CVCWHR FX LEGEND COPY PACK TREND: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_token} (trend={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['trend']}, pack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['copyPack']}, priorPack={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorCopyPack']}, Δ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['deltaHours']:+.1f}h, priorΔ={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorDeltaHours']:+.1f}h, shift={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['momentumShiftHours']:+.1f}h, loaded={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['priorLoaded']}, reason={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_signals['reason']})",
        f"- CVCWHR FX LEGEND CPT: {combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_token} (flag={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['flagName']}, enabled={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['flagEnabled']}, trend={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['trend']}, alias={combat_vfx_cadence_coach_why_hysteresis_confidence_floor_fx_pulse_legend_copy_pack_trend_alias_signals['alias']})",
        ...
        f"- CBGCL: {cadence_bridge_glyph_confidence_legend_compact_alias} (flag={cadence_bridge_glyph_confidence_legend_compact_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_legend_compact_alias_signals['flagEnabled']}, legendAlias={cadence_bridge_glyph_confidence_legend_compact_alias_signals['alias']})",
        f"- CBGCIA: {cadence_bridge_glyph_confidence_intent_tone_pack_active_alias} (flag={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['flagEnabled']}, cue={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['cue']}, current={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['current']}, alias={cadence_bridge_glyph_confidence_intent_tone_pack_active_alias_signals['aliasToken']})",
        f"- CBGCIA FAMILY CHURN: +{token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['added']} / -{token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['removed']} / net {token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['net']} (churn={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceNarrativeIntentTonePackActiveAlias']['coverage']})",
        f"- CBGCFXR: {cadence_bridge_glyph_confidence_fx_pulse_regime_alias} (flag={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['flagEnabled']}, alias={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['aliasToken']}, regime={cadence_bridge_glyph_confidence_fx_pulse_regime_alias_signals['volatilityRegime']})",
        f"- CBGCFXR FAMILY CHURN: +{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['added']} / -{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['removed']} / net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['net']} (churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseRegimeAlias']['coverage']})",
        f"- CBGCFXA: {cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias} (flag={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['flagEnabled']}, alias={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['aliasToken']}, mode={cadence_bridge_glyph_confidence_fx_pulse_aggressiveness_alias_signals['aggressivenessMode']})",
        f"- CBGCFXA FAMILY CHURN: +{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['added']} / -{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['removed']} / net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['net']} (churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseAggressivenessAlias']['coverage']})",
        f"- CBGC FX HINT: {cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint} (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['flagEnabled']}, mode={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['aggressivenessMode']}, pulse={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_signals['resolvedPulse']})",
        f"- CBGC FX HINT FAMILY CHURN: +{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['added']} / -{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['removed']} / net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['net']} (churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintAlias']['coverage']})",
        f"- CBGCFXH: {cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias} (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['flagEnabled']}, alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['aliasToken']}, mode={cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint_compact_alias_signals['aggressivenessMode']})",
        f"- CBGCFXH FAMILY CHURN: +{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['added']} / -{token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['removed']} / net {token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['net']} (churn={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['churn']} coverage={token_family_totals['cadenceBridgeGlyphConfidenceFxPulseMicrocopyHintCompactAlias']['coverage']})",
        f"- CBGCFXW: {cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias} (flag={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals['flagName']}, enabled={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals['flagEnabled']}, alias={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals['aliasToken']}, cue={cadence_bridge_glyph_confidence_fx_pulse_microcopy_world_tone_alias_signals['worldToneCue']})",
