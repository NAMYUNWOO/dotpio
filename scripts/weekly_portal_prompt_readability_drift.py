...
def resolve_cadence_bridge_glyph_confidence_fx_pulse_microcopy_hint(
    *,
    ...
    """Human-readable offline triage hint derived from CBGC FX aggressiveness mode."""
    ...
    hint = hint_map.get(mode, hint_map["BASELINE"])
