...
TOKEN_ALIAS_FAMILIES = {
    ...
    "combatVfxCadenceCoachWhyHysteresisConfidenceFloorFxPulseLegendCopyPackAlias": ["CVCWHR FX LEGEND COPY PACK:", "CVCWHR FX LEGEND CP:"],
