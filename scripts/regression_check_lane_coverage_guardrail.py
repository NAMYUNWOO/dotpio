...
def run_fixture_case(
    *,
    ...
    assert re.search(
        r"trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack candidate \(combat/vfx\+ai-content, report-only\): \*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2:(ABR|XCF|SHH)\*\*",
        md_text,
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack candidate row"
    assert (
    ...
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack legend (design/world+combat/vfx): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2LEG:ABR=anchor brace reserve|XCF=crossfire cut feint|SHH=shelter hold harden**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack legend row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack eval (ux/design): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2LEN:B68|C53|LIM72|PASS**"
        in md_text
    ...
    assert (
        ...
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control legend companion row"
    assert re.search(
        r"trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner token \(systems/qa, report-only\): \*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLW:(A|B|C)\*\*",
        md_text,
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner token row"
    assert re.search(
        r"trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX pulse cue \(combat/vfx\+systems/qa, report-only\): \*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFX:(GLINT-HOLD|PULSE-CUT|SHIELD-HOLD)\*\*",
        md_text,
    ...
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX pulse cue decode helper eval (ux/design, report-only): "
    ...
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval (ux/design, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN:B69|C69|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval decode row (design/world+combat/vfx+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG:K=KEEP lane|R=ROLLBACK lane**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval decode row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval decode length row (combat/vfx+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN:B31|C31|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner VFX rollback helper eval decode length row"
    assert re.search(
        ...
        md_text,
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note decode helper (design/world+combat/vfx): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNH:A=lane-lock|B=pressure-shift|C=stabilize-hold**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note decode helper row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note decode helper eval (ux/design, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNHLEN:B45|C45|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note decode helper eval row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper (design/world+combat/vfx+ai-content, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB:KEEP if CTRLWNH/CTRLWNHLEN remain PASS|ROLLBACK on helper drift**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper row"
    assert (
        ...
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG:K=KEEP confidence lane|R=ROLLBACK confidence lane**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper eval decode row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper legend pairing row (design/world+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEG:K=confidence KEEP lane|R=confidence ROLLBACK lane**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper legend pairing row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper alternate legend variant (combat/vfx+ai-content, report-only + rollback safety gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALT:K=KEEP confidence rail|R=ROLLBACK confidence rail|SAFE=CTRLWNRB**"
        in md_text
    ), f"{name}: markdown output must include confidence-note rollback helper alternate legend variant row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper alternate legend safety-anchor length eval row (combat/vfx+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTSAFE:B13|C13|LIM72|PASS**"
        in md_text
    ...
    assert (
        ...
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPIN:ALT>PIN>SAFE>ALTLEN**"
        in md_text
    ...
    assert (
        "docs-order sentinel VFX handoff cue alternate phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT:PIN=GLINT flare|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX alternate handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue alternate phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALTLEN:B33|C33|LIM72|PASS**"
        in md_text
    ...
    assert (
        "docs-order sentinel VFX handoff cue fourth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3:PIN=GLINT pulse|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX fourth handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue fourth phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3LEN:B33|C33|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX fourth handoff phrase eval row"
    assert (
        "docs-order sentinel VFX handoff cue fifth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4:PIN=GLINT guard|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX fifth handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue fifth phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4LEN:B33|C33|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX fifth handoff phrase eval row"
    assert (
        "docs-order sentinel VFX handoff cue sixth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5:PIN=GLINT flash|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX sixth handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue sixth phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5LEN:B33|C33|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX sixth handoff phrase eval row"
    assert (
        "docs-order sentinel VFX handoff cue seventh phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6:PIN=GLINT sparkline|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX seventh handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue seventh phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6LEN:B37|C37|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX seventh handoff phrase eval row"
    assert (
        "docs-order sentinel VFX handoff cue eighth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7:PIN=GLINT beacon|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX eighth handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue eighth phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7LEN:B34|C34|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX eighth handoff phrase eval row"
    assert (
        "docs-order sentinel VFX handoff cue ninth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8:PIN=GLINT guardrail|SAFE=SHIELD brace**"
        in md_text
    ), f"{name}: markdown output must include docs-order sentinel VFX ninth handoff phrase candidate row"
    assert (
        "docs-order sentinel VFX handoff cue ninth phrase eval row (ai-content+ux, report-only + rollback wording gate): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8LEN:B37|C37|LIM72|PASS**"
        in md_text
    ...
    assert (
        ...
        in md_text
    ), f"{name}: markdown output must include confidence-note rollback helper alternate legend length eval row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper legend pairing eval row (design/world+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN:B53|C53|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper legend pairing eval row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper eval decode length row (design/world+ux, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN:B49|C37|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence-note rollback helper eval decode length row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note eval (ux/design, report-only): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN:B67|C61|LIM72|PASS**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner confidence note eval row"
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control winner decode helper (design/world): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWLEG:A=ABR winner|B=XCF winner|C=SHH winner**"
        in md_text
    ...
    assert (
        ...
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack control rollback row"
    stalf2_control_winner_chain_matches = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLW:[^*]+\*\*.*?"
        ...
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN:[^*]+\*\*.*?"
        ...
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEG:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALT:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPIN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINSAFE:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTSAFE:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWLEG:[^*]+\*\*.*?"
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWLEN:[^*]+\*\*.*?"
    ...
    assert (
        ...
        in md_text
    ), f"{name}: markdown output must include ALT23 docs-order helper callout for true-north/SAFE readability"
    assert (
        ...
        in md_text
    ), f"{name}: markdown output must include ALT25 docs-order helper callout for prow/SAFE readability"
    assert (
    ...
    alt27_alt28_alias_order_matches = re.findall(
        ...
        r"ALT28=`assertionLabel=<\.\.\.legaltpinvfxalt28NonPassRows>` \| "
        r"ALT28LEN=`assertionLabel=<\.\.\.legaltpinvfxalt28lenNonPassRows>` \| "
        r"ALT28R=`assertionLabel=<\.\.\.legaltpinvfxalt28rNonPassRows>` \| "
        r"ALT29=`assertionLabel=<\.\.\.legaltpinvfxalt29NonPassRows>` \| "
        r"ALT29LEN=`assertionLabel=<\.\.\.legaltpinvfxalt29lenNonPassRows>` \| "
        r"ALT29R=`assertionLabel=<\.\.\.legaltpinvfxalt29rNonPassRows>` \| "
        ...
        r"ALT28V29LEN=`assertionLabel=<\.\.\.legaltpinvfxalt28v29lenNonPassRows>` \| "
        r"ALT28V29R=`assertionLabel=<\.\.\.legaltpinvfxalt28v29rNonPassRows>`\.",
        md_text,
    )
    ...
    assert (
        "trend-score dispatch-pressure momentum fx urgency guidance confidence recommendation intensity trend beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack rollback criteria (qa/systems): "
        "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2RB:KEEP if ABR/XCF/SHH clarity holds + LIM72 pass|ROLLBACK if ambiguity or width fail**"
        in md_text
    ), f"{name}: markdown output must include beat-side quick-map narrative alias intensity pack backcompat shelter-tone fallback cue micro-pack rollback row"
    assert (
    ...
    nfxqbackstaf2_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2:([^*]+)\*\*",
            md_text,
        )
    ]
    ...
    assert nfxqbackstaf2_payload_values, (
        f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2 row to carry an ABR|XCF|SHH payload across summary/token sections"
    )
    invalid_nfxqbackstaf2_payload = next(
        (
            (index, payload)
            for index, payload in enumerate(nfxqbackstaf2_payload_values)
            if payload not in {"ABR", "XCF", "SHH"}
        ),
        None,
    )
    assert invalid_nfxqbackstaf2_payload is None, (
    ...
    nfxqbackstaf2ctrlw_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLW:([^*]+)\*\*",
            md_text,
    ...
    nfxqbackstaf2ctrlwvfx_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFX:([^*]+)\*\*",
            md_text,
    ...
    nfxqbackstaf2ctrlwvfxrblg_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG:([^*]+)\*\*",
            md_text,
    ...
    nfxqbackstaf2ctrlwnrb_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB:([^*]+)\*\*",
            md_text,
    ...
    nfxqbackstaf2ctrlwnrblg_payload_values = [
        payload.strip()
        for payload in re.findall(
            r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG:([^*]+)\*\*",
            md_text,
    ...
    if control_legend_present:
        assert nfxqbackstaf2ctrlw_payload_values, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLW row when control legend row is present"
        )
        assert (
            "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWLEG:A=ABR winner|B=XCF winner|C=SHH winner**"
            in md_text
        ...
        assert (
            ...
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNHLEN row when control legend row is present"
        )
        assert (
            "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN:B67|C61|LIM72|PASS**"
            in md_text
        ), (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN row when control legend row is present"
        )
        assert nfxqbackstaf2ctrlwvfx_payload_values, (
        ...
        assert (
            ...
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG row when control legend row is present"
        )
        assert (
            "**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN:B31|C31|LIM72|PASS**"
            in md_text
        ), (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN row when control legend row is present"
        )
        ...
        assert (
            ...
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG row when control legend row is present"
        )
        invalid_nfxqbackstaf2ctrlw_payload = next(
            (
                (index, payload)
                for index, payload in enumerate(nfxqbackstaf2ctrlw_payload_values)
                if payload not in {"A", "B", "C"}
            ),
            None,
        )
        assert invalid_nfxqbackstaf2ctrlw_payload is None, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLW payload to stay within A|B|C when control legend row is present; "
            f"first diverged occurrence={invalid_nfxqbackstaf2ctrlw_payload[0]} payload={invalid_nfxqbackstaf2ctrlw_payload[1]}"
        )
        invalid_nfxqbackstaf2ctrlwvfx_payload = next(
            (
                (index, payload)
                for index, payload in enumerate(nfxqbackstaf2ctrlwvfx_payload_values)
                if payload not in {"GLINT-HOLD", "PULSE-CUT", "SHIELD-HOLD"}
            ),
            None,
        )
        ...
        invalid_nfxqbackstaf2ctrlwvfxrblg_payload = next(
            (
                (index, payload)
                for index, payload in enumerate(nfxqbackstaf2ctrlwvfxrblg_payload_values)
                if payload != "K=KEEP lane|R=ROLLBACK lane"
            ),
            None,
        )
        assert invalid_nfxqbackstaf2ctrlwvfxrblg_payload is None, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG payload to stay deterministic when control legend row is present; "
            f"first diverged occurrence={invalid_nfxqbackstaf2ctrlwvfxrblg_payload[0]} payload={invalid_nfxqbackstaf2ctrlwvfxrblg_payload[1]}"
        )
        invalid_nfxqbackstaf2ctrlwn_payload = next(
            (
                (index, payload)
                for index, payload in enumerate(nfxqbackstaf2ctrlwn_payload_values)
                if payload
                not in {
                    "A:anchor brace reserve confidence lane-lock",
                    "B:crossfire cut feint confidence pressure-shift",
                    "C:shelter hold harden confidence stabilize-hold",
                }
            ),
            None,
        )
        assert invalid_nfxqbackstaf2ctrlwn_payload is None, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWN payload to stay deterministic when control legend row is present; "
            f"first diverged occurrence={invalid_nfxqbackstaf2ctrlwn_payload[0]} payload={invalid_nfxqbackstaf2ctrlwn_payload[1]}"
        )
        invalid_nfxqbackstaf2ctrlwnrb_payload = next(
            (
                (index, payload)
                for index, payload in enumerate(nfxqbackstaf2ctrlwnrb_payload_values)
                if payload
                != "KEEP if CTRLWNH/CTRLWNHLEN remain PASS|ROLLBACK on helper drift"
            ),
            None,
        )
        assert invalid_nfxqbackstaf2ctrlwnrb_payload is None, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB payload to stay deterministic when control legend row is present; "
            f"first diverged occurrence={invalid_nfxqbackstaf2ctrlwnrb_payload[0]} payload={invalid_nfxqbackstaf2ctrlwnrb_payload[1]}"
        )
        invalid_nfxqbackstaf2ctrlwnrblg_payload = next(
            (
                (index, payload)
        ...
        assert invalid_nfxqbackstaf2ctrlwnrblg_payload is None, (
            f"{name}: fixture-level domain assertion requires TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG payload to stay deterministic when control legend row is present; "
            f"first diverged occurrence={invalid_nfxqbackstaf2ctrlwnrblg_payload[0]} payload={invalid_nfxqbackstaf2ctrlwnrblg_payload[1]}"
        )
    ...
    nfxqbackstaflen_eval_non_pass_rows = tuple(
        row for row in nfxqbackstaflen_eval_rows if not row.strip().endswith("|PASS")
    )
    nfxqbackstaf2ctrlwnlen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnhlen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNHLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnhlen_eval_non_pass_rows = tuple(
        row for row in nfxqbackstaf2ctrlwnhlen_eval_rows if not row.strip().endswith("|PASS")
    )
    nfxqbackstaf2ctrlwvfxrblen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN:([^*\n]+)\*\*",
        md_text,
    )
    ...
    nfxqbackstaf2ctrlwvfxrblglen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwvfxrblglen_eval_non_pass_rows = tuple(
        row
        for row in nfxqbackstaf2ctrlwvfxrblglen_eval_rows
        if not row.strip().endswith("|PASS")
    )
    ...
    nfxqbackstaf2ctrlwnrblglen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglen_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglen_eval_rows)
        if payload != "B49|C37|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblgleglen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblgleglen_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblgleglen_eval_rows)
        if payload != "B53|C53|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltsafe_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTSAFE:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltsafe_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltsafe_eval_rows)
        if payload != "B13|C13|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltlen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltlen_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltlen_eval_rows)
        if payload != "B63|C63|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpin_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPIN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpin_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
    ...
    nfxqbackstaf2ctrlwnrblglegaltpinsafe_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINSAFE:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinsafe_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinsafe_payload_values)
        if payload != "PIN=guard before SAFE gate"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfx_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFX:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfx_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfx_payload_values)
        if payload != "PIN=GLINT latch|SAFE=SHIELD hold"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxaltlen_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALTLEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxaltlen_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
    ...
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_payload_values)
        if payload != "PIN=GLINT pulse|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_eval_rows)
        if payload != "B33|C33|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_payload_values)
        if payload != "PIN=GLINT guard|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_eval_rows)
        if payload != "B33|C33|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_payload_values)
        if payload != "PIN=GLINT flash|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_eval_rows)
        if payload != "B33|C33|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_payload_values)
        if payload != "PIN=GLINT sparkline|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_eval_rows)
        if payload != "B37|C37|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_payload_values)
        if payload != "PIN=GLINT beacon|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8_payload_values)
        if payload != "PIN=GLINT guardrail|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8len_eval_rows)
        if payload != "B37|C37|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_payload_values)
        if payload
        != "GLINT guardrail keeps pin intent explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_payload_values)
        if payload != "PIN=GLINT tether|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_payload_values)
        if payload
        != "GLINT tether keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_payload_values)
        if payload != "PIN=GLINT anchor|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_payload_values)
        if payload
        != "GLINT anchor keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_payload_values)
        if payload != "PIN=GLINT stabilizer|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_eval_rows)
        if payload != "B38|C38|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_payload_values)
        if payload
        != "GLINT stabilizer keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_payload_values)
        if payload != "PIN=GLINT relay|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_eval_rows)
        if payload != "B33|C33|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_payload_values)
        if payload
        != "GLINT relay keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_payload_values)
        if payload != "PIN=GLINT beacon|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_payload_values)
        if payload
        != "GLINT beacon keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14_payload_values)
        if payload != "PIN=GLINT waypoint|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14len_eval_rows)
        if payload != "B36|C36|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14r_payload_values)
        if payload
        != "GLINT waypoint keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15_payload_values)
        if payload != "PIN=GLINT vector|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt15r_payload_values)
        if payload
    ...
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17_payload_values)
        if payload != "PIN=GLINT trajectory|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17len_eval_rows)
        if payload != "B38|C38|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt17r_payload_values)
        if payload
    ...
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19_payload_values)
        if payload != "PIN=GLINT bearing|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19len_eval_rows)
        if payload != "B35|C35|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19r_payload_values)
        if payload
        != "GLINT bearing keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_payload_values)
        if payload != "PIN=GLINT heading|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_eval_rows)
        if payload != "B35|C35|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_payload_values)
        if payload
        != "GLINT heading keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22_payload_values)
        if payload != "PIN=GLINT meridian|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22len_eval_rows)
        if payload != "B36|C36|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22r_payload_values)
        if payload
        != "GLINT meridian keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_payload_values)
        if payload != "PIN=GLINT true-north|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_eval_rows)
        if payload != "B38|C38|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_payload_values)
        if payload
        != "GLINT true-north keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_eval_rows)
        if payload != "B45|C45|LIM72|PREF:TIE|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_payload_values)
        if payload != "ALT22 meridian and ALT23 true-north keep pin readability parity"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_eval_rows)
        if payload != "B42|C42|LIM72|PREF:TIE|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_payload_values)
        if payload != "ALT19 bearing and ALT20 heading keep pin readability parity"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_eval_rows)
        if payload != "B37|C37|LIM72|PREF:TIE|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_payload_values)
        if payload != "ALT25 prow and ALT26 mast keep pin readability parity"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_payload_values)
        if payload != "PIN=GLINT rudder|SAFE=SHIELD brace"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_eval_rows)
        if payload != "B34|C34|LIM72|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_payload_values)
        if payload
        != "GLINT rudder keeps pin handoff explicit|SAFE brace preserves readability"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_eval_rows = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27LEN:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_eval_rows)
        if payload != "B39|C39|LIM72|PREF:TIE|PASS"
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_payload_values = re.findall(
        r"\*\*TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27R:([^*\n]+)\*\*",
        md_text,
    )
    nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
    ...
    nfxqbackstaf2ctrlwvfxrb_payload_mismatch_rows = tuple(
        f"occurrence={index} payload={payload}"
        for index, payload in enumerate(nfxqbackstaf2ctrlwvfxrb_payload_values)
        if payload
        != "KEEP if CTRLWVFXH/CTRLWVFXHLEN stay PASS|ROLLBACK on VFX helper drift"
    ...
    stalf2_control_winner_chain_tokens = (
        ...
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN",
        ...
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEG",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALT",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPIN",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINLEN",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTSAFE",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTLEN",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN",
        "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN",
    ...
    return {
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstafPayloads": tuple(nfxqbackstaf_payload_values),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2Payloads": tuple(nfxqbackstaf2_payload_values),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN:B69|C69|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblgRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG:K=KEEP lane|R=ROLLBACK lane**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblglenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN:B31|C31|LIM72|PASS**"),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrbRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB:KEEP if CTRLWNH/CTRLWNHLEN remain PASS|ROLLBACK on helper drift**"),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3:PIN=GLINT pulse|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3LEN:B33|C33|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4:PIN=GLINT guard|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4LEN:B33|C33|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5:PIN=GLINT flash|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5LEN:B33|C33|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6:PIN=GLINT sparkline|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6LEN:B37|C37|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7:PIN=GLINT beacon|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7LEN:B34|C34|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8:PIN=GLINT guardrail|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8LEN:B37|C37|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9:PIN=GLINT tether|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9LEN:B34|C34|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10:PIN=GLINT anchor|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10LEN:B34|C34|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11:PIN=GLINT stabilizer|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11LEN:B38|C38|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12:PIN=GLINT relay|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12LEN:B33|C33|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13:PIN=GLINT beacon|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13LEN:B34|C34|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt14RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14:PIN=GLINT waypoint|SAFE=SHIELD brace**"),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19:PIN=GLINT bearing|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19LEN:B35|C35|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19R:GLINT bearing keeps pin handoff explicit|SAFE brace preserves readability**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20:PIN=GLINT heading|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20LEN:B35|C35|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20R:GLINT heading keeps pin handoff explicit|SAFE brace preserves readability**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22:PIN=GLINT meridian|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22LEN:B36|C36|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22R:GLINT meridian keeps pin handoff explicit|SAFE brace preserves readability**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23:PIN=GLINT true-north|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23LEN:B38|C38|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23R:GLINT true-north keeps pin handoff explicit|SAFE brace preserves readability**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23LEN:B45|C45|LIM72|PREF:TIE|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23R:ALT22 meridian and ALT23 true-north keep pin readability parity**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20LEN:B42|C42|LIM72|PREF:TIE|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20R:ALT19 bearing and ALT20 heading keep pin readability parity**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26LEN:B37|C37|LIM72|PREF:TIE|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26R:ALT25 prow and ALT26 mast keep pin readability parity**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27RowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27:PIN=GLINT rudder|SAFE=SHIELD brace**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27lenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27LEN:B34|C34|LIM72|PASS**"),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN:B49|C37|LIM72|PASS**"),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnlenRowCount": md_text.count("**TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN:B67|C61|LIM72|PASS**"),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblglenNonPassRows": " || ".join(nfxqbackstaf2ctrlwvfxrblglen_eval_non_pass_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrbNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrb_payload_mismatch_rows),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt14NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt14lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt14rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt14r_payload_mismatch_rows),
        ...
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27NonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_payload_mismatch_rows),
        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27lenNonPassRows": " || ".join(nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_payload_mismatch_rows),
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="regression_check_lane_guardrail_") as tmp:
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads: list[tuple[str, tuple[str, ...]]] = []
        ...
        mixed_window_tsdpmfx_alt_beat_helper_parity.append(
            (
                ...
                int(balanced_tie_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2RowCount"]),
                int(balanced_tie_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2lenRowCount"]),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads.append(
            (
                "balanced_tie",
                tuple(balanced_tie_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstafPayloads"]),
            )
        )
        ...
        mixed_window_tsdpmfx_alt_beat_helper_parity.append(
            (
                ...
                int(ready_mix_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2RowCount"]),
                int(ready_mix_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2lenRowCount"]),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads.append(
            (
                "ready_mix",
                tuple(ready_mix_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstafPayloads"]),
            )
        )
        mixed_window_tsdpmfx_nfxqback_vfxa_domain_payloads.append(
            (
        ...
        mixed_window_tsdpmfx_alt_beat_helper_parity.append(
            (
                ...
                int(prior_window_trend_up_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2RowCount"]),
                int(prior_window_trend_up_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2lenRowCount"]),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads.append(
            (
                "prior_window_trend_up",
                tuple(prior_window_trend_up_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstafPayloads"]),
            )
        )
        mixed_window_tsdpmfx_nfxqback_vfxa_domain_payloads.append(
            (
        ...
        mixed_window_tsdpmfx_alt_beat_helper_parity.append(
            (
                ...
                int(prior_window_trend_down_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2RowCount"]),
                int(prior_window_trend_down_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2lenRowCount"]),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads.append(
            (
                "prior_window_trend_down",
                tuple(prior_window_trend_down_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstafPayloads"]),
            )
        )
        mixed_window_tsdpmfx_nfxqback_vfxa_domain_payloads.append(
            (
        ...
        mixed_window_tsdpmfx_nfxqbackstaf_domain_mismatch = next(
            (
                (fixture_name, index, payload)
                for fixture_name, payloads in mixed_window_tsdpmfx_nfxqbackstaf_domain_payloads
                for index, payload in enumerate(payloads)
                if payload not in {"AGF", "CRF", "SHD"}
            ),
            None,
        )
        assert mixed_window_tsdpmfx_nfxqbackstaf_domain_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF payload constrained to AGF|CRF|SHD across summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf_domain_mismatch[0]} "
            f"occurrence={mixed_window_tsdpmfx_nfxqbackstaf_domain_mismatch[1]} "
            f"payload={mixed_window_tsdpmfx_nfxqbackstaf_domain_mismatch[2]}"
        )
        ...
        mixed_window_tsdpmfx_nfxqbackstaflen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaflenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaflen_status_mismatch is None, (
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnhlen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnhlenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnhlen_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNHLEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnhlen_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnhlen_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblen_status_mismatch is None, (
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblglen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblglenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblglen_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblglen_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrblglen_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrb_payload_mismatch = next(
            (
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrbNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrb_payload_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRB payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrb_payload_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrb_payload_mismatch[1]}"
        )
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglen_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglen_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglen_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblgleglen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblgleglenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblgleglen_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblgleglen_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblgleglen_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltsafe_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltsafe_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTSAFE payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltsafe_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltsafe_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_label = (
            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltlenNonPassRows"
        )
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTLEN payload deterministic across sparse summary + token sections; "
            f"assertionLabel={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_label}; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltlen_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpin_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpin_status_mismatch is None, (
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinsafe_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINSAFE payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinsafe_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinsafe_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxNonPassRows"
                        ]
                    )
                )
            ),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_label = (
            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxNonPassRows"
        )
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFX payload deterministic across sparse summary + token sections; "
            f"assertionLabel={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_label}; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfx_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxaltlen_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxaltlenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxaltlen_status_mismatch is None, (
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3 payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt3lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT3LEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt3len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4 payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt4lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT4LEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt4len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5 payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt5lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5LEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt5len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6 payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt6lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6LEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt6len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7 payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt7lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7LEN domain-constrained to PASS across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt7len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8NonPassRows"
                        ]
                    )
                )
            ),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8len_status_mismatch = next(
            (
                (fixture_name, non_pass_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt8rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt8r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9NonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9lenNonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9rNonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt9rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt9r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10NonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10lenNonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_status_mismatch = next(
            (
                (
                    fixture_name,
                    fixture_result[
                        "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10rNonPassRows"
                    ],
                )
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt10rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt10r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt11rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt11r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt12rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt12r_status_mismatch[1]}"
        )

        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt13rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt13r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT13R payload deterministic across sparse summary + token sections; "
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt20rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt20r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20R payload deterministic across sparse summary + token sections; "
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23LEN domain-constrained to PASS across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt23rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt23r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23LEN payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt22v23r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_status_mismatch = next(
            (
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20LEN payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20lenRowCount"
                        ]
                    ),
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rRowCount"
                        ]
                    ),
                )
                for fixture_name, fixture_result in (
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_row_count_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20R row-count parity with "
            "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20LEN so missing rationale rows expose comparator occurrence context in one failure path; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_row_count_mismatch[0]} "
            f"expected={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_row_count_mismatch[1]} "
            f"actual={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt19v20r_row_count_mismatch[2]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26LEN payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26lenRowCount"
                        ]
                    ),
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rRowCount"
                        ]
                    ),
                )
                for fixture_name, fixture_result in (
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_row_count_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26R row-count parity with "
            "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26LEN so missing rationale rows expose comparator occurrence context in one failure path; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_row_count_mismatch[0]} "
            f"expected={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_row_count_mismatch[1]} "
            f"actual={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt25v26r_row_count_mismatch[2]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27NonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27 payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27NonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27LEN payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27lenRowCount"
                        ]
                    ),
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27rRowCount"
                        ]
                    ),
                )
                for fixture_name, fixture_result in (
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_row_count_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27R row-count parity with "
            "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27LEN so missing rationale rows expose comparator occurrence context in one failure path; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt27rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_row_count_mismatch[0]} "
            f"expected={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_row_count_mismatch[1]} "
            f"actual={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt27r_row_count_mismatch[2]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27lenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27LEN payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27lenNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27len_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_status_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27rNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_status_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27R payload deterministic across sparse summary + token sections; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27rNonPassRows; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_status_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_status_mismatch[1]}"
        )
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27lenRowCount"
                        ]
                    ),
                    int(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27rRowCount"
                        ]
                    ),
                )
                for fixture_name, fixture_result in (
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27r_row_count_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27R row-count parity with "
            "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27LEN so missing rationale rows expose comparator occurrence context in one failure path; "
            "assertionLabel=tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinvfxalt26v27rNonPassRows; "
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnlen_status_mismatch = next(
            (
                ...
                if (
                    non_pass_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnlenNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnlen_status_mismatch is None, (
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrb_payload_mismatch = next(
            (
                (fixture_name, mismatch_rows)
                for fixture_name, fixture_result in (
                    ("balanced_tie", balanced_tie_result),
                ...
                if (
                    mismatch_rows := str(
                        fixture_result[
                            "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrbNonPassRows"
                        ]
                    )
                )
            ),
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrb_payload_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRB payload deterministic across sparse summary + token sections; "
            f"first diverged fixture={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrb_payload_mismatch[0]} "
            f"rows={mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfxrb_payload_mismatch[1]}"
        )
        stalf2_control_chain_sparse_row_keys = (
            ...
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLG",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblgRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFXRBLGLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxrblglenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWN",
            ...
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLG",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblgRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEG",
            ...
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltpinlenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINSAFE",
            ...
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglegaltlenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblgleglenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEN",
                "tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwnrblglenRowCount",
            ),
            (
                "TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNLEN",
        ...
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrl_sparse_first_missing_token is None, (
            ...
            "...NFXQBACKSTAF2CTRLW -> ...NFXQBACKSTAF2CTRLWVFX -> ...NFXQBACKSTAF2CTRLWVFXH -> ...NFXQBACKSTAF2CTRLWVFXHLEN -> ...NFXQBACKSTAF2CTRLWVFXRB -> ...NFXQBACKSTAF2CTRLWVFXRBLEN -> ...NFXQBACKSTAF2CTRLWVFXRBLG -> ...NFXQBACKSTAF2CTRLWVFXRBLGLEN -> ...NFXQBACKSTAF2CTRLWN -> ...NFXQBACKSTAF2CTRLWNH -> ...NFXQBACKSTAF2CTRLWNHLEN -> ...NFXQBACKSTAF2CTRLWNRB -> ...NFXQBACKSTAF2CTRLWNRBLG -> ...NFXQBACKSTAF2CTRLWNRBLGLEG -> ...NFXQBACKSTAF2CTRLWNRBLGLEGLEN -> ...NFXQBACKSTAF2CTRLWNRBLGLEN -> ...NFXQBACKSTAF2CTRLWNLEN -> ...NFXQBACKSTAF2CTRLWLEG -> ...NFXQBACKSTAF2CTRLWLEN -> ...NFXQBACKSTAF2CTRLRB; "
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfx_row_count_mismatch = next(
            (
                (
                    fixture_name,
                ...
                if int(fixture_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlRowCount"]) > 0
                and int(fixture_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlwvfxRowCount"])
                != int(fixture_result["tsdpmfxvwcritspmbcbnxdmapnfxqbackstaf2ctrlRowCount"])
            ),
            None,
        )
        assert mixed_window_tsdpmfx_nfxqbackstaf2ctrlwvfx_row_count_mismatch is None, (
            "mixed-window fixture matrix must keep TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWVFX row-count parity with "
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinlen_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
        ...
        mixed_window_tsdpmfx_nfxqbackstaf2ctrlwnrblglegaltpinsafe_row_count_mismatch = next(
            (
                (
                    fixture_name,
                    int(
