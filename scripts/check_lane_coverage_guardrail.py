...
def to_markdown(
    ...
    return "\n".join(
        ...
        "- cadence 24h recovery triad coverage spread trend confidence momentum score vfx cue hysteresis confidence drift-trend smoothing-pressure decode operator cue decode (design/world): **TSDCAD24TRICOVSTCMSVHCSTPRLENCUE legend (LOCK=GLINT-HOLD, WATCH=PULSE-PROBE)**",
            ...
            "- docs-order sentinel VFX handoff cue sixth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5:PIN=GLINT flash|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue sixth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT5LEN:B33|C33|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue seventh phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6:PIN=GLINT sparkline|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue seventh phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT6LEN:B37|C37|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue eighth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7:PIN=GLINT beacon|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue eighth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT7LEN:B34|C34|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue ninth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8:PIN=GLINT guardrail|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue ninth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8LEN:B37|C37|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue ninth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT8R:GLINT guardrail keeps pin intent explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue tenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9:PIN=GLINT tether|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue tenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9LEN:B34|C34|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue tenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT9R:GLINT tether keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue eleventh phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10:PIN=GLINT anchor|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue eleventh phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10LEN:B34|C34|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue eleventh phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT10R:GLINT anchor keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twelfth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11:PIN=GLINT stabilizer|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twelfth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11LEN:B38|C38|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twelfth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT11R:GLINT stabilizer keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue thirteenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12:PIN=GLINT relay|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue thirteenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12LEN:B33|C33|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue thirteenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT12R:GLINT relay keeps pin handoff explicit|SAFE brace preserves readability**",
            ...
            "- docs-order ALT9 helper callout (design/world+ux): `...LEGALTPINVFXALT9` keeps **GLINT=tethered pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT10 helper callout (design/world+ux): `...LEGALTPINVFXALT10` keeps **GLINT=anchored pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT11 helper callout (design/world+ux): `...LEGALTPINVFXALT11` keeps **GLINT=stabilized pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT12 helper callout (design/world+ux): `...LEGALTPINVFXALT12` keeps **GLINT=relay pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT13 helper callout (design/world+ux): `...LEGALTPINVFXALT13` keeps **GLINT=beacon pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT14 helper callout (design/world+ux): `...LEGALTPINVFXALT14` keeps **GLINT=waypoint pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT15 helper callout (design/world+ux): `...LEGALTPINVFXALT15` keeps **GLINT=vector pin handoff intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT16 helper callout (design/world+ux): `...LEGALTPINVFXALT16` keeps **GLINT=beeline pin intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT17 helper callout (design/world+ux): `...LEGALTPINVFXALT17` keeps **GLINT=trajectory pin intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT18 helper callout (design/world+ux): `...LEGALTPINVFXALT18` keeps **GLINT=compass pin intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT19 helper callout (design/world+ux): `...LEGALTPINVFXALT19` keeps **GLINT=bearing pin intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            "- docs-order ALT20 helper callout (design/world+ux): `...LEGALTPINVFXALT20` keeps **GLINT=heading pin intent** + **SHIELD=SAFE brace readability cue** for one-scan triage.",
            ...
            "- docs-order sentinel VFX handoff cue fifteenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14:PIN=GLINT waypoint|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue fifteenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14LEN:B36|C36|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue fifteenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT14R:GLINT waypoint keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue sixteenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15:PIN=GLINT vector|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue sixteenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15LEN:B34|C34|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue sixteenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT15R:GLINT vector keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue seventeenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT16:PIN=GLINT beeline|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue seventeenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT16LEN:B35|C35|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue seventeenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT16R:GLINT beeline keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue eighteenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17:PIN=GLINT trajectory|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue eighteenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17LEN:B38|C38|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue eighteenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT17R:GLINT trajectory keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue nineteenth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT18:PIN=GLINT compass|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue nineteenth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT18LEN:B35|C35|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue nineteenth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT18R:GLINT compass keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twentieth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19:PIN=GLINT bearing|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twentieth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19LEN:B35|C35|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twentieth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19R:GLINT bearing keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-first phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20:PIN=GLINT heading|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-first phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20LEN:B35|C35|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-first phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT20R:GLINT heading keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-second phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT21:PIN=GLINT azimuth|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-second phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT21LEN:B35|C35|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-second phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT21R:GLINT azimuth keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-third phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22:PIN=GLINT meridian|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-third phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22LEN:B36|C36|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-third phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22R:GLINT meridian keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-fourth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23:PIN=GLINT true-north|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-fourth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23LEN:B38|C38|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-fourth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23R:GLINT true-north keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-fifth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT24:PIN=GLINT keel|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-fifth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT24LEN:B32|C32|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-fifth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT24R:GLINT keel keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-sixth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25:PIN=GLINT prow|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-sixth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25LEN:B32|C32|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-sixth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25R:GLINT prow keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-seventh phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26:PIN=GLINT mast|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-seventh phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26LEN:B32|C32|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-seventh phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26R:GLINT mast keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-eighth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27:PIN=GLINT rudder|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-eighth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27LEN:B34|C34|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-eighth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27R:GLINT rudder keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order sentinel VFX handoff cue twenty-ninth phrase candidate (ai-content+combat/vfx, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT29:PIN=GLINT tide|SAFE=SHIELD brace**",
            "- docs-order sentinel VFX handoff cue twenty-ninth phrase eval row (ai-content+ux, report-only + rollback wording gate): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT29LEN:B32|C32|LIM72|PASS**",
            "- docs-order sentinel VFX handoff cue twenty-ninth phrase rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT29R:GLINT tide keeps pin handoff explicit|SAFE brace preserves readability**",
            "- docs-order ALT22 vs ALT23 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23LEN:B45|C45|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT22 vs ALT23 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT22V23R:ALT22 meridian and ALT23 true-north keep pin readability parity**",
            "- docs-order ALT23 vs ALT24 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23V24LEN:B41|C41|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT23 vs ALT24 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT23V24R:ALT23 true-north and ALT24 keel keep pin readability parity**",
            "- docs-order ALT19 vs ALT20 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20LEN:B42|C42|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT19 vs ALT20 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT19V20R:ALT19 bearing and ALT20 heading keep pin readability parity**",
            "- docs-order ALT25 vs ALT26 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26LEN:B37|C37|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT25 vs ALT26 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT25V26R:ALT25 prow and ALT26 mast keep pin readability parity**",
            "- docs-order ALT26 vs ALT27 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27LEN:B39|C39|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT26 vs ALT27 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT26V27R:ALT26 mast and ALT27 rudder keep pin readability parity**",
            "- docs-order ALT27 vs ALT28 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27V28LEN:B43|C43|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT27 vs ALT28 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT27V28R:ALT27 rudder and ALT28 harbor keep pin readability parity**",
            "- docs-order ALT28 vs ALT29 readability comparator row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT28V29LEN:B39|C39|LIM72|PREF:TIE|PASS**",
            "- docs-order ALT28 vs ALT29 readability rationale row (design/world+ux, report-only): **TSDPMFXVWCRITSPMBCBNXDMAPNFXQBACKSTAF2CTRLWNRBLGLEGALTPINVFXALT28V29R:ALT28 harbor and ALT29 tide keep pin readability parity**",
