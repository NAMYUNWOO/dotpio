...
def to_markdown(
    ...
    return "\n".join(
        [
            ...
            "- cadence 24h triad gap NVH/INIT pair decode (design/world): **TSDCAD24TRIGAPNVH legend (INIT=state shorthand feeding action helper; H/HOLD R/RAMP L/RELIEF S/SHIFT; DOS:LIM72/PASS)**",
