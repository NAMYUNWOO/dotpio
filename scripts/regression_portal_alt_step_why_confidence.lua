-- Regression: portal ALT STEP WHY confidence micro-cue experiment flag.
-- Run: DOTPIO_EXPERIMENT_ALT_STEP_CUE=1 DOTPIO_EXPERIMENT_ALT_STEP_CONF=1 DOTPIO_EXPERIMENT_ALT_STEP_WHY=1 DOTPIO_EXPERIMENT_ALT_STEP_WHY_CONF=1 lua scripts/regression_portal_alt_step_why_confidence.lua
...
expect(detailed:find("ALT STEP WHY CONF:MID", 1, true), "detailed prompt should include ALT STEP WHY CONF token")
...
expect(compact:find("ALT STEP WHY CONF:MID", 1, true), "compact prompt should include ALT STEP WHY CONF token")

Portal.cancelTransition()
print("[PASS] portal ALT STEP WHY confidence micro-cue regression validated")
