...
-- Run: DOTPIO_EXPERIMENT_ALT_STEP_CUE=1 DOTPIO_EXPERIMENT_ALT_STEP_CONF=1 DOTPIO_EXPERIMENT_ALT_STEP_WHY=1 DOTPIO_EXPERIMENT_ALT_STEP_WHY_CONF=1 DOTPIO_EXPERIMENT_ALT_WHY_GLYPH=1 DOTPIO_EXPERIMENT_ALT_WHY_GLYPH_MODE=1 lua scripts/regression_portal_alt_why_glyph.lua
...
local glyphModeEnabled = os.getenv("DOTPIO_EXPERIMENT_ALT_WHY_GLYPH_MODE")
...
expect(glyphModeEnabled == "1" or glyphModeEnabled == "true" or glyphModeEnabled == "on" or glyphModeEnabled == "yes", "set DOTPIO_EXPERIMENT_ALT_WHY_GLYPH_MODE=1 when running this regression")
