...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="portal-prompt-drift-reg-") as td:
        ...
        assert combo_conf_dccfxv_family_churn_idx == combo_conf_dccfxcpa_copy_family_churn_idx + 1, (
            "expected DCCFXV FAMILY CHURN row directly after DCCFXCPA COPY FAMILY CHURN row"
        )
