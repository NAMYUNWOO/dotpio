-- Regression: compact portal route afterglow cue experiment flags.
-- Run: DOTPIO_EXPERIMENT_PORTAL_VIBE_TRAIL=1 DOTPIO_EXPERIMENT_PORTAL_VIBE_TRAIL_WHY=1 DOTPIO_EXPERIMENT_PORTAL_VIBE_TRAIL_ARC=1 DOTPIO_EXPERIMENT_ROUTE_GLOW=1 DOTPIO_EXPERIMENT_ROUTE_GLOW_CONF=1 lua scripts/regression_portal_route_glow.lua
...
expect(calmCompact:find("ROUTE GLOW CONF:MID", 1, true), "compact prompt should include MID glow confidence for RECOVER arc")
...
expect(ashCompact:find("ROUTE GLOW CONF:HIGH", 1, true), "compact prompt should include HIGH glow confidence for SCAR arc")
Portal.cancelTransition()
clearPortalTile()
